...
/**
 * Reads the user-visible session name without inventing a placeholder.
 *
 * @param getSessionName Pi session name getter.
 * @returns Trimmed session name, or undefined when no name exists.
 */
export function getVisibleSessionName(getSessionName: ExtensionAPI["getSessionName"]): string | undefined {
