...
import { defaultModelPerProvider } from "../../../../../node_modules/@mariozechner/pi-coding-agent/dist/core/model-resolver.js";
import { getAuthPath } from "../../../../../node_modules/@mariozechner/pi-coding-agent/dist/config.js";
import { LoginDialogComponent } from "../../../../../node_modules/@mariozechner/pi-coding-agent/dist/modes/interactive/components/login-dialog.js";
...
export async function showOAuthLoginDialog(providerId: string, ctx: ExtensionCommandContext, pi: ExtensionAPI): Promise<void> {
  ...
  await ctx.ui.custom<void>((tui, _theme, _keybindings, done) => {
    ...
    return dialog;
  }, { overlay: true, overlayOptions: { anchor: "center", width: "80%", minWidth: 80, maxHeight: "85%" } });
}
