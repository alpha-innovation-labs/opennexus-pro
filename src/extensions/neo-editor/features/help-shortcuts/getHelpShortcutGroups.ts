import { formatShortcut, getRegisteredShortcuts } from "../../../shared/shortcuts/index.js";
...
export function getHelpShortcutGroups(): HelpShortcutGroup[] {
  ...
  return [
    ...
    ...(registeredShortcuts.length > 0 ? [{ title: "Registered Shortcuts", shortcuts: registeredShortcuts }] : []),
  ];
}
