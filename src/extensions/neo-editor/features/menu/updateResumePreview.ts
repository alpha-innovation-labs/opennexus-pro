...
import { computePaneWidths } from "../../../shared/two-pane-select-modal/index.js";
...
export function updateResumePreview(input: {
  ...
  const { rightWidth } = computePaneWidths(innerWidth, true, input.isRightPaneFocused() ? 0.3 : 0.6);
