 ...
 */
export function rewriteDirectResumeArgs(argv: readonly string[], request: ResumeCliRequest): string[] {
  if (request.mode !== "direct" || request.flagIndex === undefined || !request.target) {
    return [...argv];
  }
