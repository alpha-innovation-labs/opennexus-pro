...
import { sanitizeBinaryOutput } from "../../node_modules/@mariozechner/pi-coding-agent/dist/utils/shell.js";
...
import { isToolGroupCollapseEnabled } from "../extensions/tron/collapse/state.ts";
