...
import { getProjectConfigDirName } from "@nexus/runtime/config/getProjectConfigDirName.js";
 ...
 * Any name is allowed — names matching defaults (e.g. "Librarian") override them.
 */
