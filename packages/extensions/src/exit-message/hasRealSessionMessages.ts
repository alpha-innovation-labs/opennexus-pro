...
type SessionManagerLike = Pick<ExtensionContext, "sessionManager">["sessionManager"] & {
 ...
 */
export function hasRealSessionMessages(ctx?: Pick<ExtensionContext, "sessionManager">): boolean {
