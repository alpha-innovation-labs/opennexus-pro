...
import { QueuedPromptlineEditor } from "./QueuedPromptlineEditor.js";
 ...
 */
export function installPromptQueueEditor(ctx: ExtensionContext, deps: PromptQueueEditorDeps): void {
