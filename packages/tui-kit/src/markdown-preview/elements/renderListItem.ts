...
export function renderListItem(
	depth: number,
	orderedNumber: number | undefined,
	content: string,
	...
	const styledMarker = styleMarkdownPreviewSegment(
		theme,
		"list.marker",
		marker,
	);
...
function extractTaskPrefix(
	content: string,
): { state: "checked" | "todo" | "unchecked"; content: string } | undefined {
