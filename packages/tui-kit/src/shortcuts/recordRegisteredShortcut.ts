 ...
 */
export function recordRegisteredShortcut(shortcut: string, definition: Record<string, unknown>): void {
  const description = typeof definition.description === "string" ? definition.description : shortcut;
