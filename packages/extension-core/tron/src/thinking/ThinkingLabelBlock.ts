	...
	render(width: number): string[] {
		...
		const lines = measureTronRender(
			...
			() => {
				...
				if (this.connectFromTool)
					lines.unshift(theme.fg("borderMuted", previousToolBorder));
				return lines;
			},
