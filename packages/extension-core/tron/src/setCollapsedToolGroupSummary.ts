 ...
 */
export function setCollapsedToolGroupSummary(toolCallId: string, summaryText: string, fullThinkingText: string, thinkingStartedAt?: number): void {
	...
	if (typeof thinkingStartedAt === "number") stats.thinkingStartedAt = thinkingStartedAt;
}
