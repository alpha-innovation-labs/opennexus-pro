...
import { createDynamicCommandItems, extractSkillName, isFusedSkillValue } from "./createDynamicCommandItems";
...
import { updateResumePreview, type ResumePreviewState } from "./updateResumePreview";
