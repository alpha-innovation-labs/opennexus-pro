	...
	return sortSlashMenuItemsByLabel([
		{
			...
			value: "autoCompact",
			currentValue: String(settings.getCompactionEnabled()),
			options: ["true", "false"],
		},
		{
			kind: "toggle",
			...
			value: "showImages",
			currentValue: String(settings.getShowImages()),
			options: ["true", "false"],
		},
		{
			kind: "toggle",
			...
			value: "autoResizeImages",
			currentValue: String(settings.getImageAutoResize()),
			options: ["true", "false"],
		},
		{
			kind: "toggle",
			...
			value: "blockImages",
			currentValue: String(settings.getBlockImages()),
			options: ["true", "false"],
		},
		{
			kind: "toggle",
			...
			value: "enableSkillCommands",
			currentValue: String(settings.getEnableSkillCommands()),
			options: ["true", "false"],
		},
		{
			kind: "toggle",
			...
			value: "showHardwareCursor",
			currentValue: String(settings.getShowHardwareCursor()),
			options: ["true", "false"],
		},
		{
			kind: "setting",
			...
			currentValue: String(settings.getEditorPaddingX()),
			options: ["0", "1", "2", "3"],
		},
		{
			kind: "setting",
		...
		},
		{
			...
			value: "clearOnShrink",
			currentValue: String(settings.getClearOnShrink()),
			options: ["true", "false"],
		},
		{
			kind: "setting",
			...
			value: "steeringMode",
			currentValue: settings.getSteeringMode(),
		...
		},
		{
			...
			value: "followUpMode",
			currentValue: settings.getFollowUpMode(),
			options: ["one-at-a-time", "all"],
		},
		{
			kind: "setting",
		...
		themeLeaf,
		{
			...
			currentValue: String(settings.getHideThinkingBlock()),
			options: ["true", "false"],
		},
		{
			kind: "toggle",
			...
			value: "collapseChangelog",
			currentValue: String(settings.getCollapseChangelog()),
			options: ["true", "false"],
		},
		{
			kind: "toggle",
			...
			value: "enableInstallTelemetry",
			currentValue: String(settings.getEnableInstallTelemetry()),
			options: ["true", "false"],
		},
		{
			kind: "setting",
		...
		},
		{
			...
			value: "quietStartup",
			currentValue: String(settings.getQuietStartup()),
			options: ["true", "false"],
		},
		{
			kind: "toggle",
