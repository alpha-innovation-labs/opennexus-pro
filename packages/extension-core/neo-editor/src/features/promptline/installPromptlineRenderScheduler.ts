const RENDER_SCHEDULER_INSTALLED = Symbol.for("nexus.promptline.renderSchedulerInstalled");
 ...
 */
export function installPromptlineRenderScheduler(tui: PromptlineScheduledTui, frameIntervalMs = DEFAULT_FRAME_INTERVAL_MS): void {
  if (typeof tui.constructor.MIN_RENDER_INTERVAL_MS === "number" && tui.constructor.MIN_RENDER_INTERVAL_MS < frameIntervalMs) {
