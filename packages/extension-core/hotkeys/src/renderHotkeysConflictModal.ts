 ...
 */
export function renderHotkeysConflictModal(uiTheme: SelectPreviewTheme, conflict: PendingHotkeysConflict, width: number): string[] {
  ...
  return [
    ...
    uiTheme.fg("warning", "│") + padVisible(uiTheme.bold("Hotkey conflict"), innerWidth) + uiTheme.fg("warning", "│"),
    uiTheme.fg("warning", "│") + padVisible(conflictText.slice(0, innerWidth), innerWidth) + uiTheme.fg("warning", "│"),
    uiTheme.fg("warning", "│") + padVisible(targetText.slice(0, innerWidth), innerWidth) + uiTheme.fg("warning", "│"),
    uiTheme.fg("warning", "│") + padVisible(uiTheme.fg("dim", actionText), innerWidth) + uiTheme.fg("warning", "│"),
    uiTheme.fg("warning", `└${"─".repeat(innerWidth)}┘`),
    "",
  ];
}
