...
import { renderSubagentTranscriptLines } from "@nexus/extensions/sub-agents/ui/renderSubagentTranscriptLines.js";
...
function renderTranscript(session: LineChatSession | undefined, width: number, theme: ExtensionCommandContext["ui"]["theme"]): string[] {
	...
	return renderSubagentTranscriptLines(theme, width, toLineChatSubagentRun(selectLatestExchange(session)));
}
