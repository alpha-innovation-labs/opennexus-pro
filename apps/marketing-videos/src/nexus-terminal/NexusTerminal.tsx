...
/**
 * Renders the Nexus app inside a framed terminal window on a black background.
 *
...
export function NexusTerminal(props: NexusTerminalProps): JSX.Element {
  return (
    <AbsoluteFill style={{ background: palette.black, padding: 34, boxSizing: "border-box" }}>
      <div style={{ position: "relative", height: "100%", border: `1px solid ${palette.slate}`, borderRadius: 24, background: palette.black, boxShadow: `0 0 90px ${palette.indigo}22`, overflow: "hidden" }}>
        <div style={{ height: 54, display: "flex", alignItems: "center", gap: 12, padding: "0 22px", borderBottom: `1px solid ${palette.slate}`, background: palette.black }}>
        ...
        <div style={{ position: "relative", height: "calc(100% - 54px)", background: palette.black }}>
          {props.children}
          {props.overlay}
        </div>
      </div>
