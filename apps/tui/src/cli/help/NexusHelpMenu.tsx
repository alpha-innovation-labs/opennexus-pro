...
export function NexusHelpMenu(): React.ReactElement {
	...
	const options: Array<[string, string]> = [
		...
		[
			"--startup-profile",
			"Write startup timings to /tmp/nexus-startup-profile.log",
		],
	...
	const commands: Array<[string, string]> = [
		...
		[
			"nexus steer <session-id> <message>",
		...
		[
			"nexus observations recreate all|<id>",
			"Recreate observations from session JSONL",
		],
	...
	const piOptions: Array<[string, string]> = [
		...
		[
			"--model <pattern>",
			"Model pattern or ID (supports 'provider/id' and ':<level>')",
		],
		...
		[
			...
			"Append text or file contents to the system prompt",
		],
