/**
 * Checks whether argv contains the factory command prefix.
 *
 ...
 * @returns True when the first real CLI argument is "factory".
 */
export function hasFactoryFlag(argv: readonly string[]): boolean {
