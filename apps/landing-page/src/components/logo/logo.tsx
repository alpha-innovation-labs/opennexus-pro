...
export function Logo() {
  return (
    ...
    >
      <span className="brand-mark grid h-8 w-8 place-items-center border-0 bg-transparent" aria-hidden="true">
        <Image className="h-6 w-6 opacity-100" src="/icon.svg" alt="" width={24} height={24} priority />
      </span>
