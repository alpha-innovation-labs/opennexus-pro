...
export const showcaseGroups: readonly ShowcaseGroup[] = [
	{
		...
		examples: [
			...
			},
			{
				...
				bullets: [
					"Read and grep overrides",
					"Native project file tools",
					"Bash rewrite support",
				],
			},
			{
				id: "code-web-mcp",
		...
		examples: [
			{
				...
				bullets: [
					"Slash and @ workflows",
					"Project, branch, and context status",
					"Editor trigger submits",
				],
			},
			{
				id: "custom-operator",
				...
				bullets: [
					"Observation status widget",
					"cmux title and done sync",
