...
export function Hero() {
	return (
		<section
			className="hero-section relative grid bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,0.96),rgb(250,250,250)_58%)] text-center dark:bg-[radial-gradient(circle_at_50%_0%,rgba(20,20,20,0.96),#000_58%)]"
			id="top"
		>
