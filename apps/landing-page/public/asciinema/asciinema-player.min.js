// biome-ignore lint/correctness/noInnerDeclarations: all: minified file
var _AsciinemaPlayer = ((A) => {
	function B(A) {
	...
	class g {
		constructor(A, B) {
			(this.logger = A), (this.prefix = B);
		}
		log(A) {
			for (
				var B = arguments.length, Q = new Array(B > 1 ? B - 1 : 0), g = 1;
				g < B;
				g++
			)
				Q[g - 1] = arguments[g];
			this.logger.log(`${this.prefix}${A}`, ...Q);
		}
		debug(A) {
			for (
				var B = arguments.length, Q = new Array(B > 1 ? B - 1 : 0), g = 1;
				...
				Q[g - 1] = arguments[g];
			this.logger.debug(`${this.prefix}${A}`, ...Q);
		}
		info(A) {
			for (
				var B = arguments.length, Q = new Array(B > 1 ? B - 1 : 0), g = 1;
				...
				Q[g - 1] = arguments[g];
			this.logger.info(`${this.prefix}${A}`, ...Q);
		}
		warn(A) {
			for (
				var B = arguments.length, Q = new Array(B > 1 ? B - 1 : 0), g = 1;
				...
				Q[g - 1] = arguments[g];
			this.logger.warn(`${this.prefix}${A}`, ...Q);
		}
		error(A) {
			for (
				var B = arguments.length, Q = new Array(B > 1 ? B - 1 : 0), g = 1;
				...
				Q[g - 1] = arguments[g];
			this.logger.error(`${this.prefix}${A}`, ...Q);
		}
	}
	let E;
	...
	function e(A) {
		const B = typeof A;
		if ("number" === B || "boolean" === B || null == A) return `${A}`;
		if ("string" === B) return `"${A}"`;
		if ("symbol" === B) {
			const B = A.description;
			return null == B ? "Symbol" : `Symbol(${B})`;
		}
		if ("function" === B) {
			const B = A.name;
	...
	function i() {
		return (
			(null !== C && 0 !== C.byteLength) ||
				(C = new Uint8Array(E.memory.buffer)),
			C
		);
	}
	const o =
	...
	function r(A, B, Q) {
		...
		if (I !== g) {
			0 !== I && (A = A.slice(I)),
				(E = Q(E, g, (g = I + 3 * A.length), 1) >>> 0);
			const B = i().subarray(E + I, E + g);
			(I += n(A, B).written), (E = Q(E, g, I, 1) >>> 0);
		}
		return (t = I), E;
	}
	let s = null;
	...
	function u(A, B) {
		return (A >>>= 0), h.decode(i().subarray(A, A + B));
	}
	function w(A) {
		const B = I(A);
		return (
	...
	function d(A, B) {
		return (
			...
			((null !== D && 0 !== D.byteLength) ||
				(D = new Uint32Array(E.memory.buffer)),
			D).subarray(A / 4, A / 4 + B)
		);
	}
	const f =
		"undefined" === typeof FinalizationRegistry
			? { register: () => {}, unregister: () => {} }
			: new FinalizationRegistry((A) => E.__wbg_vt_free(A >>> 0));
	class y {
		static __wrap(A) {
			A >>>= 0;
			const B = Object.create(y.prototype);
			return (B.__wbg_ptr = A), f.register(B, B.__wbg_ptr, B), B;
		}
		__destroy_into_raw() {
		...
		feed(A) {
			const B = r(A, E.__wbindgen_export_0, E.__wbindgen_export_1),
				Q = t;
			return w(E.vt_feed(this.__wbg_ptr, B, Q));
		}
		resize(A, B) {
			return w(E.vt_resize(this.__wbg_ptr, A, B));
		}
		getSize() {
			try {
				const g = E.__wbindgen_add_to_stack_pointer(-16);
				E.vt_getSize(g, this.__wbg_ptr);
				var A = a()[g / 4 + 0],
					B = a()[g / 4 + 1],
					Q = d(A, B).slice();
				return E.__wbindgen_export_2(A, 4 * B, 4), Q;
			} finally {
				E.__wbindgen_add_to_stack_pointer(16);
			}
		}
		getLine(A) {
			return w(E.vt_getLine(this.__wbg_ptr, A));
		}
		getCursor() {
			return w(E.vt_getCursor(this.__wbg_ptr));
		}
	}
	function q() {
		const A = { wbg: {} };
		return (
			(A.wbg.__wbindgen_is_string = (A) => "string" === typeof I(A)),
			(A.wbg.__wbg_new_b525de17f44a8943 = () => l([])),
			(A.wbg.__wbg_set_17224bc548dd1d7b = (A, B, Q) => {
				I(A)[B >>> 0] = w(Q);
			}),
			(A.wbg.__wbindgen_debug_string = (A, B) => {
				const Q = r(e(I(B)), E.__wbindgen_export_0, E.__wbindgen_export_1),
					g = t;
				(a()[A / 4 + 1] = g), (a()[A / 4 + 0] = Q);
			}),
			(A.wbg.__wbindgen_number_new = (A) => l(A)),
			(A.wbg.__wbindgen_bigint_from_u64 = (A) => l(BigInt.asUintN(64, A))),
			(A.wbg.__wbindgen_error_new = (A, B) => l(new Error(u(A, B)))),
			(A.wbg.__wbg_new_f9876326328f45ed = () => l(new Object())),
			(A.wbg.__wbg_set_f975102236d3c502 = (A, B, Q) => {
				I(A)[w(B)] = w(Q);
			}),
			(A.wbg.__wbg_new_f841cc6f2098f4b5 = () => l(new Map())),
			(A.wbg.__wbg_set_388c4c6422704173 = (A, B, Q) => l(I(A).set(I(B), I(Q)))),
			(A.wbg.__wbindgen_object_drop_ref = (A) => {
				w(A);
			}),
			(A.wbg.__wbindgen_string_new = (A, B) => l(u(A, B))),
			(A.wbg.__wbindgen_object_clone_ref = (A) => l(I(A))),
			(A.wbg.__wbindgen_throw = (A, B) => {
				throw new Error(u(A, B));
			}),
			A
		);
	}
	...
	async function p(A) {
		...
		("string" === typeof A ||
			...
			(A = fetch(A));
		const { instance: Q, module: g } = await (async (A, B) => {
	...
	var F = Object.freeze({
		...
		initSync: (A) => {
			...
			return (
				...
				k(new WebAssembly.Instance(A, B), A)
			);
		},
	});
	const G = [
	...
	class m {
		...
		transform(A) {
			return new m(this.input, this.xfs.concat([A]));
		}
		multiplex(A, B) {
			return new m(new S(this[Symbol.iterator](), A[Symbol.iterator](), B));
		}
		toArray() {
		...
		[Symbol.iterator]() {
			...
			return {
				next: () => {
					for (A === B.length && ((B = []), (A = 0)); 0 === B.length; ) {
						const A = this.input.next();
						if (A.done) break;
						g.step(A.value);
					}
					return (
						0 !== B.length || Q || (g.flush(), (Q = !0)),
						B.length > 0 ? { done: !1, value: B[A++] } : { done: !0 }
					);
				},
			};
		}
	...
	class S {
		constructor(A, B, Q) {
			(this.left = A), (this.right = B), (this.comparator = Q);
		}
		[Symbol.iterator]() {
			let A, B;
			return {
				next: () => {
					if (void 0 === A && void 0 !== this.left) {
						const B = this.left.next();
						B.done ? (this.left = void 0) : (A = B.value);
					}
					if (void 0 === B && void 0 !== this.right) {
						const A = this.right.next();
						A.done ? (this.right = void 0) : (B = A.value);
					}
					if (void 0 === A && void 0 === B) return { done: !0 };
					if (void 0 === A) {
						const A = B;
						return (B = void 0), { done: !1, value: A };
					}
					if (void 0 === B) {
						const B = A;
						return (A = void 0), { done: !1, value: B };
					}
			...
			const B = await A.text(),
				Q = ((A) => {
					...
					const g = new m(B)
						...
						.filter((A) => "[" === A[0])
						.map(JSON.parse);
					return { header: Q, events: g };
				})(B);
			if (void 0 !== Q) {
				const { header: A, events: B } = Q;
				if (2 === A.version) return b(A, B);
				if (3 === A.version) return Y(A, B);
				throw `asciicast v${A.version} format not supported`;
			}
			{
				const A = JSON.parse(B);
				if (1 === A.version) return U(A);
			}
		} else {
			if ("object" === typeof A && 1 === A.version) return U(A);
			if (Array.isArray(A)) {
				const B = A[0];
				if (2 === B.version) {
					return b(B, A.slice(1, A.length));
				}
				if (3 === B.version) {
					return Y(B, A.slice(1, A.length));
				}
				throw `asciicast v${B.version} format not supported`;
			}
		}
		throw "invalid data";
	}
	function U(A) {
		let B = 0;
		const Q = new m(A.stdout).map((A) => ((B += A[0]), [B, "o", A[1]]));
		return { cols: A.width, rows: A.height, events: Q };
	}
	function b(A, B) {
		return {
			cols: A.width,
	...
	function Y(A, B) {
		...
		let Q = 0;
		return (
			(B = B.map((A) => ((Q += A[0]), [Q, A[1], A[2]]))),
			{
				cols: A.term.cols,
				rows: A.term.rows,
				theme: K(A.term?.theme),
				events: B,
				idleTimeLimit: A.idle_time_limit,
			}
		);
	...
	function K(A) {
		...
		return B.test(Q) &&
			B.test(g) &&
			/^(#[0-9A-Fa-f]{6}:){7,}#[0-9A-Fa-f]{6}$/.test(E)
			? { foreground: Q, background: g, palette: E.split(":") }
			: void 0;
	}
	function x(A) {
	...
	function T() {
		let A = 0;
		return (B) =>
			"m" === B[1] ? [B[0], B[1], { index: A++, time: B[0], label: B[2] }] : B;
	}
	class H {
		constructor() {
	...
	function O(A, B, Q, g, E, V, I, e, t) {
			...
			);
		{
			...
			return (
				"number" === typeof (A = A ?? {})
					? (t.debug(`using fixed time buffer (${A} ms)`), (B = (_B) => A))
					: "function" === typeof A
						? (t.debug("using custom dynamic buffer"), (B = A({ logger: t })))
						: (t.debug("using adaptive buffer", A),
							(B = (function () {
								const { logger: A } =
									...
									{
										minBufferTime: B = 50,
										bufferLevelStep: Q = 100,
										maxBufferLevel: g = 50,
										transitionDuration: E = 500,
										peakHalfLifeUp: V = 100,
										peakHalfLifeDown: I = 1e4,
										floorHalfLifeUp: e = 5e3,
										floorHalfLifeDown: t = 100,
										idealHalfLifeUp: C = 1e3,
										idealHalfLifeDown: i = 5e3,
										safetyMultiplier: o = 1.2,
										minImprovementDuration: n = 3e3,
									...
									return (
										u <= B
											...
											: ((F = Math.ceil(u / Q)),
												(G = 1),
												(N = g),
												(p = Math.min(N, Math.max(G, F)))),
										f > a &&
											A.debug("buffer underrun", { latency: f, bufferTime: a }),
										p > s
											? (f > a ? (s = Math.min(p, s + 3)) : (s += 1),
												(D = r(s)),
												(d = (D - a) / E),
												(w = null),
					...
					return (
						...
						}, 0),
						{
							pushEvent(B) {
								let Q = o() - 1e3 * B[0];
								Q < 0 &&
									(g.debug(`correcting epoch by ${Q} ms`), (I += Q), (Q = 0)),
									(e = A(Q)),
									t.push(B);
							},
							pushText(A) {
	...
	function j(A) {
		...
		let g,
			E = (A) => {
				...
				if ("ALiS" !== B) throw "not an ALiS v1 live stream";
				E = I;
			},
			V = 0;
		function I(A) {
			const B = new P(new DataView(A)),
				Q = B.getUint8();
			if (1 !== Q) throw `expected reset (0x01) frame, got ${Q}`;
			return e(B, A);
		}
		function e(A, Q) {
			A.decodeVarUint();
			let I = A.decodeVarUint();
			(g = I), (I /= Z), (V = 0);
			const e = A.decodeVarUint(),
				C = A.decodeVarUint(),
				i = A.getUint8();
			let o;
			if (8 === i) {
				const B = 30;
				(o = z(new Uint8Array(Q, A.offset, B))), A.forward(B);
			} else if (16 === i) {
				const B = 54;
				(o = z(new Uint8Array(Q, A.offset, B))), A.forward(B);
			} else if (0 !== i) throw `alis: invalid theme format (${i})`;
			const n = A.decodeVarUint();
			let r;
			return (
				n > 0 && (r = B.decode(new Uint8Array(Q, A.offset, n))),
				(E = t),
				{ time: I, term: { size: { cols: e, rows: C }, theme: o, init: r } }
			);
		}
		function _t(t) {
			const C = new P(new DataView(t)),
				i = C.getUint8();
			return 1 === i
				? e(C, t)
				: 111 === i
					? ((A, Q) => {
							...
							const E = A.decodeVarUint();
							g += E;
							const V = A.decodeVarUint(),
								I = B.decode(new Uint8Array(Q, A.offset, V));
							return [g / Z, "o", I];
						})(C, t)
					: 105 === i
						? ((A, B) => {
								...
								g += E;
								const V = A.decodeVarUint(),
									I = Q.decode(new Uint8Array(B, A.offset, V));
								return [g / Z, "i", I];
							})(C, t)
						: 114 === i
							? ((A) => {
									A.decodeVarUint();
									const B = A.decodeVarUint();
									g += B;
									const Q = A.decodeVarUint(),
										E = A.decodeVarUint();
									return [g / Z, "r", { cols: Q, rows: E }];
								})(C)
							: 109 === i
								? ((A, B) => {
										A.decodeVarUint();
										...
										const E = A.decodeVarUint(),
											...
											e = V++,
											t = g / Z,
											C = I.decode(new Uint8Array(B, A.offset, E));
										return [t, "m", { index: e, time: t, label: C }];
									})(C, t)
								: 4 === i
									? ((E = I), !1)
									: void A.debug(`alis: unknown frame type: ${i}`);
		}
		return (A) => E(A);
	}
	function z(A) {
		const B = A.length / 3,
			...
			g = X(A[3], A[4], A[5]),
			E = [];
		for (let Q = 2; Q < B; Q++) E.push(X(A[3 * Q], A[3 * Q + 1], A[3 * Q + 2]));
		return { foreground: Q, background: g, palette: E };
	}
	function X(A, B, Q) {
		return `#${_(A)}${_(B)}${_(Q)}`;
	}
	...
	class P {
		constructor(A) {
			...
			(this.inner = A), (this.offset = B);
		}
		forward(A) {
			this.offset += A;
		}
		getUint8() {
			const A = this.inner.getUint8(this.offset);
		...
		decodeVarUint() {
			...
			for (; Q > 127; )
				(Q &= 127),
					...
					(B += BigInt(7)),
					(Q = this.getUint8());
			return (A += BigInt(Q) << B), Number(A);
		}
	}
	function $() {
		const A = new TextDecoder();
		let B = (g) => {
			const E = A.decode(g, { stream: !0 }),
				[V, I] = ((A) => {
					const B = A.match(/\x1b\[8;(\d+);(\d+)t/);
					if (null !== B) return [parseInt(B[2], 10), parseInt(B[1], 10)];
				})(E) ??
					((A) => {
						const B = A.match(/\[.*COLUMNS="(\d{1,3})" LINES="(\d{1,3})".*\]/);
						if (null !== B) return [parseInt(B[1], 10), parseInt(B[2], 10)];
					})(E) ?? [80, 24];
			return (
				(B = Q), { time: 0, term: { size: { cols: V, rows: I }, init: E } }
			);
		};
		function _Q(B) {
			return A.decode(B, { stream: !0 });
		}
		return (A) => B(A);
	}
	function AA(A) {
		const B = Math.min(500 * 2 ** A, 1e4);
		return Math.random() * B;
	}
	function BA(A) {
		if (A.length < 13) return;
		const B = ((A) => {
				const B = QA(A.subarray(0, 4)),
					Q = QA(A.subarray(4, 8));
				return B + Q / 1e6;
			})(A.subarray(0, 8)),
			Q = QA(A.subarray(8, 12));
		return { time: B, data: A.subarray(12, 12 + Q), len: Q + 12 };
	}
	function QA(A) {
		return A[0] + 256 * A[1] + 256 * A[2] * 256 + 256 * A[3] * 256 * 256;
	}
	const gA = (async (A = {}) => {
		const { initializeHook: B } = A;
		return null != B ? await B(p, M) : await p(M), F;
	})();
	class EA {
		constructor(A) {
			(this.core = A), (this.driver = A.driver);
		}
		onEnter(_A) {}
		init() {}
		play() {}
		...
		togglePlay() {}
		mute() {
			this.driver?.mute() && this.core._dispatchEvent("muted", !0);
		}
		unmute() {
			this.driver?.unmute() && this.core._dispatchEvent("muted", !1);
		}
		seek(_A) {
			return !1;
		}
	...
	class VA extends EA {
		async init() {
			try {
				...
				throw (this.core._setState("errored"), A);
			}
		}
		async play() {
	...
	class IA extends EA {
		onEnter(A) {
			const { reason: B, message: Q } = A;
			this.core._dispatchEvent("idle", { message: Q }),
				"paused" === B && this.core._dispatchEvent("pause");
		}
		async play() {
		...
		async doPlay() {
			...
			!0 === A
				...
				: "function" === typeof A &&
					(this.core._setState("playing"), (this.driver.stop = A));
		}
		async togglePlay() {
			await this.play();
		}
	...
	class CA extends EA {
		onEnter(A) {
			const { message: B } = A;
			this.core._dispatchEvent("offline", { message: B });
		}
	}
	class iA extends EA {
		onEnter(A) {
			const { message: B } = A;
			this.core._dispatchEvent("ended", { message: B });
		}
		async play() {
			this.core._dispatchEvent("play"),
		...
		async seek(A) {
			return (
				!0 === (await this.driver.seek(A)) && (this.core._setState("idle"), !0)
			);
		}
	}
	class oA extends EA {
	...
	class nA {
		constructor(A, Q) {
			(this.logger = Q.logger),
								...
								: "clock:" === A.substring(0, 6)
									...
									: "random:" === A.substring(0, 7)
										...
										: "benchmark:" === A.substring(0, 10)
											? { driver: "benchmark", url: A.substring(10) }
											: { driver: "recording", url: A });
					void 0 === A.driver && (A.driver = "recording");
					if (
						"recording" === A.driver &&
						(void 0 === A.parser && (A.parser = "asciicast"),
						"string" === typeof A.parser)
					) {
						if (!sA.has(A.parser)) throw `unknown parser: ${A.parser}`;
						A.parser = sA.get(A.parser);
					}
					if (rA.has(A.driver)) {
						const B = rA.get(A.driver);
						return (Q, g) => B(A, Q, g);
					}
				...
				(this.idleTimeLimit = Q.idleTimeLimit),
				(this.preload = Q.preload),
				(this.startAt = B(Q.startAt)),
				(this.poster = this._parsePoster(Q.poster)),
				(this.markers = this._normalizeMarkers(Q.markers)),
				(this.pauseOnMarkers = Q.pauseOnMarkers),
				(this.audioUrl = Q.audioUrl),
		...
		async init() {
			this.wasm = await gA;
			const A = this._feed.bind(this),
				B = this._resetVt.bind(this),
				Q = this._resizeVt.bind(this),
				g = this._setState.bind(this),
				E = "npt" === this.poster.type ? this.poster.value : void 0;
			(this.driver = this.driver(
				{
					feed: A,
					onInput: (A) => {
						this._dispatchEvent("input", { data: A });
					},
					onMarker: (A) => {
						const { index: B, time: Q, label: g } = A;
						this._dispatchEvent("marker", { index: B, time: Q, label: g });
					},
					reset: B,
					resize: Q,
					setState: g,
				...
				(this.preload || void 0 !== E) && this._withState((A) => A.init());
			const V =
					"text" === this.poster.type
			...
			if (
				(void 0 === this.driver.init && (this.driver.init = () => ({})),
				void 0 === this.driver.pause && (this.driver.pause = () => {}),
				void 0 === this.driver.seek && (this.driver.seek = (_A) => !1),
				void 0 === this.driver.step && (this.driver.step = (_A) => {}),
				void 0 === this.driver.stop && (this.driver.stop = () => {}),
				void 0 === this.driver.restart && (this.driver.restart = () => {}),
				void 0 === this.driver.mute && (this.driver.mute = () => {}),
				void 0 === this.driver.unmute && (this.driver.unmute = () => {}),
				void 0 === this.driver.getCurrentTime)
			) {
				const A = this.driver.play;
				let B = new L();
				(this.driver.play = () => ((B = new R(this.speed)), A())),
					(this.driver.getCurrentTime = () => B.getTime());
			}
			this._dispatchEvent("ready", I), this.autoPlay && this.play();
		}
		play() {
			return this._withState((A) => A.play());
		}
		pause() {
			return this._withState((A) => A.pause());
		}
		togglePlay() {
			return this._withState((A) => A.togglePlay());
		}
		seek(A) {
			return this._withState(async (B) => {
				(await B.seek(A)) && this._dispatchEvent("seeked");
			});
		}
		step(A) {
			return this._withState((B) => B.step(A));
		}
		stop() {
			return this._withState((A) => A.stop());
		}
		mute() {
			return this._withState((A) => A.mute());
		}
		unmute() {
			return this._withState((A) => A.unmute());
		}
		getChanges() {
			const A = {};
			if (this.changedLines.size > 0) {
				const B = new Map(),
					Q = this.vt.rows;
				for (const A of this.changedLines)
					if (A < Q) {
						const Q = this.vt.getLine(A);
						(Q.id = A), B.set(A, Q);
					}
				this.changedLines.clear(), (A.lines = B);
			}
			return (
				void 0 === this.cursor &&
					this.vt &&
					((this.cursor = this.vt.getCursor() ?? !1), (A.cursor = this.cursor)),
				A
			);
		}
		getCurrentTime() {
		...
		addEventListener(A, B) {
			this.eventHandlers.get(A).push(B);
		}
		_dispatchEvent(A) {
			const B =
				arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
			for (const Q of this.eventHandlers.get(A)) Q(B);
		}
		_withState(A) {
			return this._enqueueCommand(() => A(this.state));
		}
		_enqueueCommand(A) {
			return (this.commandQueue = this.commandQueue.then(A)), this.commandQueue;
		}
		_setState(A) {
			const B =
				arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
			if (this.stateName === A) return this.state;
			if (((this.stateName = A), "playing" === A)) this.state = new eA(this);
			else if ("idle" === A) this.state = new IA(this);
			else if ("loading" === A) this.state = new tA(this);
			else if ("ended" === A) this.state = new iA(this);
			else if ("offline" === A) this.state = new CA(this);
			else {
				if ("errored" !== A) throw `invalid state: ${A}`;
				this.state = new oA(this);
			}
			return this.state.onEnter(B), this.state;
		}
		_feed(A) {
			this._doFeed(A), this._dispatchEvent("terminalUpdate");
		}
		_doFeed(A) {
		...
		async _initializeDriver() {
			...
			(this.cols = this.cols ?? A.cols ?? 80),
				...
				(this.markers =
					this._normalizeMarkers(A.markers) ?? this.markers ?? []),
				0 === this.cols && (this.cols = 80),
				0 === this.rows && (this.rows = 24),
				this._initializeVt(this.cols, this.rows);
			const B = void 0 !== A.poster ? this._renderPoster(A.poster) : null;
			...
			const Q =
				...
				g =
					arguments.length > 3 && void 0 !== arguments[3]
						? arguments[3]
						: void 0;
			this.logger.debug(`core: vt reset (${A}x${B})`),
				(this.cols = A),
				(this.rows = B),
				(this.cursor = void 0),
				this._initializeVt(A, B),
				void 0 !== Q && "" !== Q && this._doFeed(Q),
				this._dispatchEvent("reset", { cols: A, rows: B, theme: g });
		}
		_resizeVt(A, B) {
			if (A === this.vt.cols && B === this.vt.rows) return;
			this.vt.resize(A, B).forEach((A) => this.changedLines.add(A)),
				(this.cursor = void 0),
				(this.vt.cols = A),
				(this.vt.rows = B),
				this.logger.debug(`core: vt resize (${A}x${B})`),
				this._dispatchEvent("resize", { cols: A, rows: B });
		}
		_initializeVt(A, B) {
			(this.vt = this.wasm.create(A, B, !0, 100)),
				(this.vt.cols = A),
				(this.vt.rows = B),
				this.changedLines.clear();
			for (let A = 0; A < B; A++) this.changedLines.add(A);
		}
		_parsePoster(A) {
			return "string" !== typeof A
				? {}
				: "data:text/plain," === A.substring(0, 16)
					? { type: "text", value: [A.substring(16)] }
					: "npt:" === A.substring(0, 4)
						? { type: "npt", value: B(A.substring(4)) }
						: {};
		}
		_renderPoster(A) {
			const B = this.cols ?? 80,
				Q = this.rows ?? 24;
			this.logger.debug(`core: poster init (${B}x${Q})`);
			const g = this.wasm.create(B, Q, !1, 0);
			A.forEach((A) => g.feed(A));
			const E = g.getCursor() ?? !1,
				V = [];
			for (let A = 0; A < Q; A++) {
				const B = g.getLine(A);
				(B.id = A), V.push(B);
			}
			return { cursor: E, lines: V };
		}
		_normalizeMarkers(A) {
			if (Array.isArray(A))
	...
	const rA = new Map([
			[
				...
				(A, B) => {
					let Q,
						{ url: g, iterations: E = 10 } = A,
						{ feed: V, setState: I } = B,
						e = 0;
					return {
						async init() {
							const A = await v(await fetch(g)),
								{ cols: B, rows: E, events: V } = A;
							Q = Array.from(V)
								.filter((A) => {
									const [_B, Q, _g] = A;
									return "o" === Q;
							...
							const I = Q[Q.length - 1][0];
							for (const [_A, B] of Q) e += new Blob([B]).size;
							return { cols: B, rows: E, duration: I };
						},
						play() {
							const A = performance.now();
							for (let A = 0; A < E; A++) {
								for (const [_A, B] of Q) V(B);
								V("c");
							}
							const B = (performance.now() - A) / 1e3,
								g = (e * E) / B,
								t = ((e / 1048576) * E) / B;
							return (
			...
			[
				...
				(A, B, Q) => {
					...
					return {
						init: () => {
							const A = [o].concat(r());
							return { cols: e, rows: t, duration: 1440, poster: A };
						},
						play: () => (I(o), s(), (n = setInterval(s, 1e3)), !0),
						stop: () => {
							clearInterval(n);
						},
						getCurrentTime: () => {
			...
			[
				...
				(A, B) => {
					let Q,
						E,
						{ url: V, bufferTime: I, minFrameTime: e } = A,
						{
							feed: t,
							reset: C,
							resize: i,
					...
					s = new g(s, "eventsource: ");
					let a = new L();
					function c(A) {
						void 0 !== E && E.stop(),
							(E = O(I, t, i, o, n, (A) => a.setTime(A), A, e, s));
					}
					return {
						play: () => {
							(Q = new EventSource(V)),
								...
								Q.addEventListener("error", (A) => {
									s.info("errored"), s.debug({ e: A }), r("loading");
								}),
								Q.addEventListener("message", (A) => {
									const B = JSON.parse(A.data);
									if (Array.isArray(B)) E.pushEvent(B);
									else if (void 0 !== B.cols || void 0 !== B.width) {
										const A = B.cols ?? B.width,
											Q = B.rows ?? B.height;
										s.debug(`vt reset (${A}x${Q})`),
											r("playing"),
											c(B.time),
											C(A, Q, B.init ?? void 0),
											(a = new R()),
											"number" === typeof B.time && a.setTime(B.time);
									} else
										"offline" === B.state &&
											(s.info("stream offline"),
											r("offline", { message: "Stream offline" }),
											(a = new L()));
								}),
								Q.addEventListener("done", () => {
									s.info("closed"),
										Q.close(),
										r("ended", { message: "Stream ended" });
								});
						},
						stop: () => {
							void 0 !== E && E.stop(), void 0 !== Q && Q.close();
						},
						getCurrentTime: () => a.getTime(),
					};
				},
			],
			[
				...
				(_A, B, Q) => {
					...
					let e;
					const t = () => {
							const A = 5 ** (4 * Math.random());
							e = setTimeout(C, A / E);
						},
						_C = () => {
							t();
							const A = String.fromCharCode(V + Math.floor(Math.random() * I));
							g(A);
						};
			...
			[
				...
				(A, B, Q) => {
					...
					async function b(A, B) {
						const Q = await fetch(A, B);
						if (!Q.ok)
							throw `failed fetching recording from ${A}: ${Q.status} ${Q.statusText}`;
						return Q;
					}
					function Y() {
						const A = V[M];
					...
					function O(A) {
						...
						if ("o" === Q) a(g);
							...
							return Z(), (o = 1e3 * B), u("idle", { reason: "paused" }), !0;
						return !1;
					}
					function W() {
						H(),
							L++,
							!0 === y || ("number" === typeof y && L < y)
								? ((M = 0),
									(i = v()),
									a("c"),
									_(),
									Y(),
									s && (s.currentTime = 0))
								: ((o = 1e3 * e), u("ended"), s?.pause());
					}
					function Z() {
						return (S = !1), s?.pause(), !C || (H(), (o = v() - i), !0);
					}
					async function j() {
						s &&
							!r &&
							(() => {
								r = new AudioContext({ latencyHint: "interactive" });
								const A = r.createMediaElementSource(s);
								A.connect(r.destination), (v = P);
							})(),
							(i = v() - o),
							(o = null),
							Y(),
								...
								: ">>" === A
									...
									: "<<<" === A
										...
										: ">>>" === A
											...
											: "%" === A[A.length - 1] &&
												(A =
													(parseFloat(A.substring(0, A.length - 1)) / 100) * e);
						else if ("object" === typeof A)
							if ("prev" === A.marker)
								(A = X(Q) ?? 0), B && Q - A < 1 && (A = X(A) ?? 0);
								...
								A =
									((A) => {
										...
										let B,
											Q = I.length - 1,
											g = I[Q];
										for (; g && g[0] > A; ) (B = g[0]), (g = I[--Q]);
										return B;
									})(Q) ?? e;
							else if ("number" === typeof A.marker) {
								const B = I[A.marker];
								if (void 0 === B) throw `invalid marker index: ${A.marker}`;
								A = B[0];
							}
						const g = Math.min(Math.max(A, 0), e);
						if (1e3 * g === o) return !1;
						g < R && (a("c"), _(), (M = 0), (R = 0));
						let E = V[M];
						for (; E && E[0] <= g; )
							("o" !== E[1] && "r" !== E[1]) || O(E), (R = E[0]), (E = V[++M]);
						return (
							(o = 1e3 * g),
							(t = null),
							s && U && (s.currentTime = g / D),
							B ? await j() : void 0 === V[M] && W(),
							!0
						);
					}
					function _X(A) {
					...
					function _P() {
						if (!r) throw "audio context not started - can't tell time!";
						const { contextTime: A, performanceTime: B } =
							r.getOutputTimestamp();
						return 0 === B ? 1e3 * A : 1e3 * A + (performance.now() - B);
					}
					function $() {
						if (
							(w.debug("audio buffering"),
							(J = !0),
							(S = !!C),
							(n = setTimeout(() => u("loading"), 1e3)),
							!C)
						)
							return !0;
						w.debug("pausing session playback"), H(), (o = v() - i);
					}
					function AA() {
						w.debug("audio resumed"),
							clearTimeout(n),
							u("playing"),
							J &&
								((J = !1),
								S &&
									(w.debug("resuming session playback"),
									(i = v() - o),
									(o = null),
									Y()));
					}
							...
							try {
								let B = (async (A, B, Q) => {
									const {
										...
										s = await (async (A) => {
											let { url: B, data: Q, fetchOpts: g = {} } = A;
											if ("string" === typeof B) return await b(B, g);
											if (Array.isArray(B))
												return await Promise.all(B.map((A) => b(A, g)));
											if (void 0 !== Q) {
												"function" === typeof Q && (Q = Q()),
													Q instanceof Promise || (Q = Promise.resolve(Q));
												const A = await Q;
												return "string" === typeof A || A instanceof ArrayBuffer
													? new Response(A)
													: A;
											}
										...
										a = ((A, B, Q) => {
											...
											(t = t
												...
												void 0 !== e &&
													...
													(t = t
														.filter((A) => "m" !== A[1])
														.multiplex(e, (A, B) => A[0] < B[0])
														.map(T())));
											(t = t.toArray()),
												void 0 !== I &&
													((t = t.map((A) =>
														"i" === A[1] ? [A[0] + I, A[1], A[2]] : A,
													)),
													t.sort((A, B) => A[0] - B[0]));
											const i = t[t.length - 1][0],
												o = g - C.offset;
											return {
												...A,
												events: t,
									...
									void 0 !== n &&
										((A, B) => {
											const Q = document.createElement("a"),
												g = A.events.map((A) =>
													"m" === A[1] ? [A[0], A[1], A[2].label] : A,
												),
												E = ((A) =>
													`${JSON.stringify({ version: 2, width: A.cols, height: A.rows })}\n${A.events.map(JSON.stringify).join("\n")}\n`)(
													{ ...A, events: g },
												);
											(Q.href = URL.createObjectURL(
									...
									const c =
										void 0 !== q
											? ((_l = q),
												V.filter((A) => A[0] < l && "o" === A[1]).map(
													(A) => A[2],
												))
											: void 0;
									var _l;
									return (
										(I = V.filter((A) => "m" === A[1]).map((A) => [
											A[0],
											A[2].label,
										])),
										{
								...
								})(A, w, { idleTimeLimit: d, startAt: f, markers_: k });
								const Q = await (async (A) => {
									if (!A) return !1;
									(s = await (async (A) => {
										const B = new Audio();
										let Q;
										...
										function E() {
											Q(), B.removeEventListener("canplay", E);
										}
										return (
											B.addEventListener("canplay", E),
											(B.src = A),
											B.load(),
											await g,
											B
										...
										(U =
											...
											s.duration !== 1 / 0 &&
											s.seekable.length > 0 &&
											s.seekable.end(s.seekable.length - 1) === s.duration),
										U
											? (s.addEventListener("playing", AA),
												s.addEventListener("waiting", $))
											: w.warn(
													`audio is not seekable - you must enable range request support on the server providing ${s.src} for audio seeking to work`,
												);
									return !0;
								})(N);
								return (B = await B), { ...B, hasAudio: Q };
							} finally {
								clearTimeout(B);
							}
						},
						play: async () => {
							if (C) throw "already playing";
							if (void 0 === V[M]) throw "already ended";
							return null !== t && z(t), await j(), !0;
						},
						pause: Z,
						seek: z,
						step: (A) => {
							...
							if ((void 0 === A && (A = 1), A > 0)) {
								...
								B = V[g];
								for (let E = 0; E < A; E++) {
									for (; void 0 !== B && "o" !== B[1]; ) B = V[++g];
									void 0 !== B && "o" === B[1] && (Q = g);
								}
							} else {
								let g = Math.max(M - 2, 0);
								B = V[g];
								for (let E = A; E < 0; E++) {
									for (; void 0 !== B && "o" !== B[1]; ) B = V[--g];
									void 0 !== B && "o" === B[1] && (Q = g);
							...
							if (void 0 !== Q) {
								for (; M <= Q; )
									(B = V[M++]), ("o" !== B[1] && "r" !== B[1]) || O(B);
								(R = B[0]),
									(o = 1e3 * R),
									(t = null),
									s && U && (s.currentTime = R / D),
									void 0 === V[Q + 1] && W();
							}
						},
						restart: async () => {
							if (C) throw "still playing";
							if (void 0 !== V[M]) throw "not ended";
							return z(0), await j(), !0;
						},
						stop: Z,
						mute: () => {
							if (s) return (s.muted = !0), !0;
						},
						unmute: () => {
							if (s) return (s.muted = !1), !0;
						},
						getCurrentTime: () => (C ? (v() - i) / 1e3 : (o ?? 0) / 1e3),
					};
				},
			],
			[
				...
				(A, B, Q) => {
					...
					function q() {
						(E = new WebSocket(I, [
							...
							(E.onopen = () => {
								const A = E.protocol || "raw";
								c.info("opened"),
									c.info(`activating ${A} protocol handler`),
									"v1.alis" === A
										? (E.onmessage = k(j(c)))
										: "v2.asciicast" === A
											? (E.onmessage = k(
														...
														let A = (Q) => {
															...
															return (
																(A = B),
																{
																	time: 0,
																	term: {
																		size: { cols: g.width, rows: g.height },
																	},
																}
															);
														};
														...
														(() => {
															let A = (B) => {
																	...
																	return (
																		g.term.theme &&
																			(E.theme = {
																				foreground: g.term.theme.fg,
																				background: g.term.theme.bg,
																				palette:
																					g.term.theme.palette.split(":"),
																			}),
																		{ time: 0, term: E }
																	);
																},
							...
							(E.onclose = (A) => {
								if (
									(clearTimeout(u), G(), f || 1e3 === A.code || 1005 === A.code)
								)
									c.info("closed"), a("ended", { message: "Stream ended" });
								else if (1002 === A.code)
									c.debug(`close reason: ${A.reason}`),
										a("ended", {
									...
									clearTimeout(h);
									const A = t(d++);
									c.info(`unclean close, reconnecting in ${A}...`),
										a("loading"),
										setTimeout(q, A);
								}
							}),
						...
						return (
							...
							(B) => {
								try {
									const Q = A(B.data);
									if (V)
										if (Array.isArray(Q)) V.pushEvent(Q);
										else if ("string" === typeof Q) V.pushText(Q);
										else if ("object" !== typeof Q || Array.isArray(Q)) {
											if (!1 === Q) F();
											else if (void 0 !== Q)
												throw `unexpected value from protocol handler: ${Q}`;
										} else p(Q);
									else if ("object" !== typeof Q || Array.isArray(Q)) {
										if (void 0 !== Q)
											throw (
												(clearTimeout(u),
												`unexpected value from protocol handler: ${Q}`)
											);
										clearTimeout(u), (u = setTimeout(F, 1e3));
									} else p(Q), clearTimeout(u);
								} catch (A) {
									throw (E.close(), A);
								}
							}
					...
					function _p(A) {
						const { time: B, term: Q } = A;
						const { size: g, init: E, theme: I } = Q,
							{ cols: t, rows: l } = g;
						c.info(`stream reset (${t}x${l} @${B})`),
							a("playing"),
							G(),
							(V = O(e, i, n, r, s, (A) => D.setTime(A), B, C, c)),
							o(t, l, E, I),
							(D = new R()),
							(y = !0),
							"number" === typeof B && D.setTime(B);
					}
					function _F() {
						G(),
							y
								? (c.info("stream ended"),
									a("offline", { message: "Stream ended" }))
								: (c.info("stream offline"),
									a("offline", { message: "Stream offline" })),
							(D = new L());
					}
					function G() {
						V?.stop(), (V = null);
					...
					return {
						...
						stop: () => {
							(f = !0), G(), void 0 !== E && E.close(), w?.pause();
						},
						mute: () => {
							if (w) return (w.muted = !0), !0;
						},
						unmute: () => {
							if (w) return (w.muted = !1), !0;
						},
						getCurrentTime: () => D.getTime(),
					};
				},
			],
		]),
				...
				async (A, B) => {
					...
					let E,
						...
						I = (await A[0].text())
							...
							.filter((A) => A.length > 0)
							.map((A) => A.split(" "));
					I[0].length < 3 && (I = I.map((A) => ["O", A[0], A[1]]));
					const e = await A[1].arrayBuffer(),
						t = new Uint8Array(e),
						C = t.indexOf(10) + 1,
						i = g
							.decode(t.subarray(0, C))
							.match(/COLUMNS="(\d+)" LINES="(\d+)"/);
					null !== i && ((E = parseInt(i[1], 10)), (V = parseInt(i[2], 10)));
					const o = { array: t, cursor: C };
					let n = o;
					if (void 0 !== A[2]) {
						const B = await A[2].arrayBuffer();
						n = { array: new Uint8Array(B), cursor: C };
					}
					const r = [];
					let s = 0;
					for (const A of I)
						if (((s += parseFloat(A[1])), "O" === A[0])) {
							const B = parseInt(A[2], 10),
								Q = o.array.subarray(o.cursor, o.cursor + B),
								E = g.decode(Q);
							r.push([s, "o", E]), (o.cursor += B);
						} else if ("I" === A[0]) {
							const B = parseInt(A[2], 10),
								Q = n.array.subarray(n.cursor, n.cursor + B),
								E = g.decode(Q);
							r.push([s, "i", E]), (n.cursor += B);
						} else if ("S" === A[0] && "SIGWINCH" === A[2]) {
							const B = parseInt(A[4].slice(5), 10),
								Q = parseInt(A[3].slice(5), 10);
							r.push([s, "r", `${B}x${Q}`]);
						} else
							"H" === A[0] && "COLUMNS" === A[2]
								? (E = parseInt(A[3], 10))
								: "H" === A[0] && "LINES" === A[2] && (V = parseInt(A[3], 10));
					return (E = E ?? 80), (V = V ?? 24), { cols: E, rows: V, events: r };
				},
			],
			[
				"ttyrec",
				async (A, B) => {
					const { encoding: Q } = B;
					const g = new TextDecoder(Q),
						E = await A.arrayBuffer(),
						V = new Uint8Array(E),
						I = BA(V),
						e = I.time,
						t = g.decode(I.data).match(/\x1b\[8;(\d+);(\d+)t/),
						C = [];
					let i = 80,
						o = 24;
					null !== t && ((i = parseInt(t[2], 10)), (o = parseInt(t[1], 10)));
					let n = 0,
						r = BA(V);
					for (; void 0 !== r; ) {
						const A = r.time - e,
							B = g.decode(r.data);
						C.push([A, "o", B]), (n += r.len), (r = BA(V.subarray(n)));
					}
					return { cols: i, rows: o, events: C };
				},
			],
		]);
	const aA = Symbol("solid-proxy"),
		cA = "function" === typeof Proxy,
		lA = Symbol("solid-track"),
		hA = { equals: (A, B) => A === B };
	let uA = jA;
	const wA = 1,
		DA = 2,
		dA = { owned: null, cleanups: null, context: null, owner: null };
	var fA = null;
	let yA = null,
		qA = null,
		kA = null,
	...
	function NA(A, B) {
		const Q = {
			...
			observers: null,
			observerSlots: null,
			comparator: (B = B ? Object.assign({}, hA, B) : hA).equals || void 0,
		};
		return [
			xA.bind(Q),
			(A) => ("function" === typeof A && (A = A(Q.value)), TA(Q, A)),
		];
	}
	function MA(A, B, _Q) {
		HA(OA(A, B, !1, wA));
	...
	function RA(A, B, Q) {
		Q = Q ? Object.assign({}, hA, Q) : hA;
		const g = OA(A, B, !0, 0);
		return (
			(g.observers = null),
			(g.observerSlots = null),
			(g.comparator = Q.equals || void 0),
			HA(g),
			xA.bind(g)
		);
	}
	...
	function JA(A) {
		!((A, B) => {
			uA = zA;
			const Q = OA(A, B, !1, wA);
			(Q.user = !0), pA ? pA.push(Q) : HA(Q);
		})(() => mA(A));
	}
	function SA(A) {
		return (
			null === fA ||
				(null === fA.cleanups ? (fA.cleanups = [A]) : fA.cleanups.push(A)),
			A
		);
	}
	function vA() {
	...
	function xA() {
		if (this.sources && this.state)
			if (this.state === wA) HA(this);
			else {
				const A = kA;
				(kA = null), ZA(() => XA(this), !1), (kA = A);
			}
		if (qA) {
			const A = this.observers ? this.observers.length : 0;
			qA.sources
				? (qA.sources.push(this), qA.sourceSlots.push(A))
				: ((qA.sources = [this]), (qA.sourceSlots = [A])),
				this.observers
					? (this.observers.push(qA),
						this.observerSlots.push(qA.sources.length - 1))
					: ((this.observers = [qA]),
						(this.observerSlots = [qA.sources.length - 1]));
		}
		return this.value;
	}
	function TA(A, B, _Q) {
				...
				A.observers?.length &&
					ZA(() => {
						for (let B = 0; B < A.observers.length; B += 1) {
							const Q = A.observers[B],
								g = yA?.running;
							g && yA.disposed.has(Q),
								(g ? Q.tState : Q.state) ||
									(Q.pure ? kA.push(Q) : pA.push(Q), Q.observers && _A(Q)),
								g || (Q.state = wA);
						}
						if (kA.length > 1e6) throw ((kA = []), new Error());
					}, !1)),
			B
		);
	}
	function HA(A) {
		...
		!((A, B, Q) => {
			...
			try {
				...
				return (
					A.pure && ((A.state = wA), A.owned?.forEach(PA), (A.owned = null)),
					(A.updatedAt = Q + 1),
					$A(B)
				);
			} finally {
			...
			(!A.updatedAt || A.updatedAt <= Q) &&
				(null != A.updatedAt && "observers" in A ? TA(A, g) : (A.value = g),
				(A.updatedAt = Q));
		})(A, A.value, B);
	}
	function OA(A, B, Q, g = wA, _E) {
		const V = {
			fn: A,
			state: g,
			updatedAt: null,
			...
			value: B,
			owner: fA,
			context: fA ? fA.context : null,
			pure: Q,
		};
		return (
			null === fA ||
				(fA !== dA && (fA.owned ? fA.owned.push(V) : (fA.owned = [V]))),
			V
		);
	}
	function WA(A) {
		if (0 === A.state) return;
		if (A.state === DA) return XA(A);
		if (A.suspense && mA(A.suspense.inFallback))
			return A.suspense.effects.push(A);
		const B = [A];
		for (; (A = A.owner) && (!A.updatedAt || A.updatedAt < FA); )
			A.state && B.push(A);
		for (let Q = B.length - 1; Q >= 0; Q--)
			if ((A = B[Q]).state === wA) HA(A);
			else if (A.state === DA) {
				const Q = kA;
				(kA = null), ZA(() => XA(A, B[0]), !1), (kA = Q);
			}
	}
	function ZA(A, B) {
		if (kA) return A();
		...
		try {
			...
			return (
				((A) => {
					...
					if (A) return;
					const B = pA;
					(pA = null), B.length && ZA(() => uA(B), !1);
				})(Q),
				B
			);
		} catch (A) {
			Q || (pA = null), (kA = null), $A(A);
		}
	}
	function jA(A) {
		for (let B = 0; B < A.length; B++) WA(A[B]);
	}
	function zA(A) {
		let B,
			Q = 0;
		...
		for (B = 0; B < Q; B++) WA(A[B]);
	}
	function XA(A, B) {
		A.state = 0;
		for (let Q = 0; Q < A.sources.length; Q += 1) {
			const g = A.sources[Q];
			if (g.sources) {
				const A = g.state;
				A === wA
					? g !== B && (!g.updatedAt || g.updatedAt < FA) && WA(g)
					: A === DA && XA(g, B);
			}
		}
	}
	...
	function PA(A) {
		...
		if (A.sources)
			for (; A.sources.length; ) {
				const B = A.sources.pop(),
					Q = A.sourceSlots.pop(),
					g = B.observers;
				if (g?.length) {
					const A = g.pop(),
						E = B.observerSlots.pop();
					Q < g.length &&
						((A.sourceSlots[E] = Q), (g[Q] = A), (B.observerSlots[Q] = E));
				}
			}
		if (A.tOwned) {
			for (B = A.tOwned.length - 1; B >= 0; B--) PA(A.tOwned[B]);
			delete A.tOwned;
		}
		if (A.owned) {
			for (B = A.owned.length - 1; B >= 0; B--) PA(A.owned[B]);
			A.owned = null;
		}
		if (A.cleanups) {
			for (B = A.cleanups.length - 1; B >= 0; B--) A.cleanups[B]();
			A.cleanups = null;
		}
		A.state = 0;
	}
	function $A(A, _B = fA) {
		const Q = ((A) =>
			A instanceof Error
				? A
				: new Error("string" === typeof A ? A : "Unknown error", { cause: A }))(
			A,
		);
		throw Q;
	}
	function AB(A) {
		if ("function" === typeof A && !A.length) return AB(A());
		if (Array.isArray(A)) {
			const B = [];
			for (let Q = 0; Q < A.length; Q++) {
				const g = AB(A[Q]);
				Array.isArray(g) ? B.push.apply(B, g) : B.push(g);
			}
			return B;
		}
		return A;
	}
	const BB = Symbol("fallback");
	function QB(A) {
	...
	const VB = {
		get: (A, B, Q) => (B === aA ? Q : A.get(B)),
		has: (A, B) => B === aA || A.has(B),
		set: EB,
		deleteProperty: EB,
	...
	const tB = (A) => `Stale read from <${A}>.`;
	function CB(A) {
		const B = "fallback" in A && { fallback: () => A.fallback };
		return RA(
			((A, B, Q = {}) => {
				let g = [],
					E = [],
				...
				return (
					...
					() => {
							...
							mA(() => {
								...
								if (0 === o)
									0 !== I &&
										...
										Q.fallback &&
											((g = [BB]),
											(E[0] = GA((A) => ((V[0] = A), Q.fallback()))),
											(I = 1));
								else if (0 === I) {
									for (E = new Array(o), C = 0; C < o; C++)
										(g[C] = i[C]), (E[C] = GA(n));
									I = o;
								} else {
									for (
									...
									for (
										...
										(r[h] = E[l]), (s[h] = V[l]), e && (a[h] = e[l]);
									for (A = new Map(), B = new Array(h + 1), C = h; C >= c; C--)
										(u = i[C]),
											(t = A.get(u)),
											(B[C] = void 0 === t ? -1 : t),
											A.set(u, C);
						...
						function _n(A) {
							if (((V[C] = A), e)) {
								const [A, Q] = NA(C);
								return (e[C] = Q), B(i[C], A);
							}
							return B(i[C]);
						}
					}
				);
			})(() => A.each, A.children, B || void 0),
		);
	}
	function iB(A) {
		const B = "fallback" in A && { fallback: () => A.fallback };
							...
							mA(() => {
								...
								for (
									...
									g < E.length && E[g] !== C[g]
										? e[g](() => C[g])
										: g >= E.length && (V[g] = GA(o));
								for (; g < E.length; g++) I[g]();
								return (
									(t = e.length = I.length = i),
									(E = C.slice(0)),
									(V = V.slice(0, t))
								);
							})
	...
	function oB(A) {
		const B = A.keyed,
			Q = RA(() => A.when, void 0, void 0),
			g = B ? Q : RA(Q, void 0, { equals: (A, B) => !A === !B });
		return RA(
			() => {
				const E = g();
				if (E) {
					const V = A.children;
					return "function" === typeof V && V.length > 0
						? mA(() =>
								V(
									B
										? E
										: () => {
												if (!mA(g)) throw tB("Show");
												return Q();
											},
								),
							)
			...
			Q = RA(() => {
				...
				for (let A = 0; A < Q.length; A++) {
					const B = A,
						E = Q[A],
						V = g,
						I = RA(() => (V() ? void 0 : E.when), void 0, void 0),
						e = E.keyed ? I : RA(I, void 0, { equals: (A, B) => !A === !B });
					g = () => V() || (e() ? [B, I, E] : void 0);
				}
				return g;
			});
	...
	const sB = "_$DX_DELEGATE";
	function aB(A, B, Q, g = {}) {
		let E;
		return (
			GA((g) => {
				(E = g),
					B === document ? A() : fB(B, A(), B.firstChild ? null : void 0, Q);
			}, g.owner),
			() => {
				E(), (B.textContent = "");
			}
	...
	function cB(A, B, Q, _g) {
		let E;
		const V = () => {
				const B = document.createElement("template");
				return (
					(B.innerHTML = A),
					Q ? B.content.firstChild.firstChild : B.content.firstChild
				);
			},
			I = B
				? () => mA(() => document.importNode(E || (E = V()), !0))
				: () => (E || (E = V())).cloneNode(!0);
		return (I.cloneNode = I), I;
	}
	function lB(A, B = window.document) {
		const Q = B[sB] || (B[sB] = new Set());
		for (let g = 0, E = A.length; g < E; g++) {
			const E = A[g];
			Q.has(E) || (Q.add(E), B.addEventListener(E, yB));
		}
	}
	function hB(A, B, Q) {
	...
	function uB(A, B) {
		null == B ? A.removeAttribute("class") : (A.className = B);
	}
	function wB(A, B, Q, _g) {
		Array.isArray(Q)
			? ((A[`$$${B}`] = Q[0]), (A[`$$${B}Data`] = Q[1]))
			: (A[`$$${B}`] = Q);
	}
	function DB(A, B, Q) {
		if (!B) return Q ? hB(A, "style") : B;
		const g = A.style;
		if ("string" === typeof B) return (g.cssText = B);
		let E, V;
		for (V in ("string" === typeof Q && (g.cssText = Q = void 0),
		Q || (Q = {}),
		B || (B = {}),
		Q))
			null == B[V] && g.removeProperty(V), delete Q[V];
		for (V in B) (E = B[V]), E !== Q[V] && (g.setProperty(V, E), (Q[V] = E));
		return Q;
	}
	function dB(A, B, Q) {
		return mA(() => A(B, Q));
	...
	function fB(A, B, Q, g) {
		if ((void 0 === Q || g || (g = []), "function" !== typeof B))
			return qB(A, B, g, Q);
		MA((g) => qB(A, B(), g, Q), g);
	}
	function yB(A) {
		...
		const Q = `$$${A.type}`,
			...
			E = A.currentTarget,
			V = (B) =>
				Object.defineProperty(A, "target", { configurable: !0, value: B }),
			I = () => {
				const g = B[Q];
				if (g && !B.disabled) {
					const E = B[`${Q}Data`];
					if ((void 0 !== E ? g.call(B, E, A) : g.call(B, A), A.cancelBubble))
						return;
				}
				return (
					B.host &&
			...
			e = () => {
				for (; I() && (B = B._$host || B.parentNode || B.host); );
			};
		if (
			...
			const Q = A.composedPath();
			V(Q[0]);
			for (let A = 0; A < Q.length - 2 && ((B = Q[A]), I()); A++) {
				if (B._$host) {
					(B = B._$host), e();
					break;
				}
				if (B.parentNode === E) break;
			}
		} else e();
		V(g);
	}
	function qB(A, B, Q, g, E) {
		for (; "function" === typeof Q; ) Q = Q();
		if (B === Q) return Q;
		const V = typeof B,
			I = void 0 !== g;
		if (
			((A = (I && Q[0]?.parentNode) || A), "string" === V || "number" === V)
		) {
			if ("number" === V && (B = B.toString()) === Q) return Q;
			if (I) {
				let E = Q[0];
				E && 3 === E.nodeType
					? E.data !== B && (E.data = B)
				...
				Q =
					"" !== Q && "string" === typeof Q
						? (A.firstChild.data = B)
						: (A.textContent = B);
		} else if (null == B || "boolean" === V) Q = FB(A, Q, g);
		else {
			if ("function" === V)
				return (
					MA(() => {
			...
			if (Array.isArray(B)) {
				const V = [],
					e = Q && Array.isArray(Q);
				if (kB(V, B, Q, E)) return MA(() => (Q = qB(A, V, Q, g, !0))), () => Q;
				if (0 === V.length) {
					if (((Q = FB(A, Q, g)), I)) return Q;
				} else
					e
						? 0 === Q.length
							? pB(A, V, g)
							: ((A, B, Q) => {
									...
									for (; I < E || e < V; )
										if (B[I] !== Q[e]) {
											...
											if (E === I) {
												const B =
													V < g ? (e ? Q[e - 1].nextSibling : Q[V - e]) : t;
												for (; e < V; ) A.insertBefore(Q[e++], B);
											} else if (V === e)
												for (; I < E; ) C?.has(B[I]) || B[I].remove(), I++;
											else if (B[I] === Q[V - 1] && Q[e] === B[E - 1]) {
												const g = B[--E].nextSibling;
												A.insertBefore(Q[e++], B[I++].nextSibling),
													A.insertBefore(Q[--V], g),
													(B[E] = Q[V]);
											} else {
												if (!C) {
													C = new Map();
												...
												if (null != g)
													if (e < g && g < V) {
														...
														if (o > g - e) {
															const E = B[I];
															for (; e < g; ) A.insertBefore(Q[e++], E);
														} else A.replaceChild(Q[e++], B[I++]);
													} else I++;
												else B[I++].remove();
											}
										} else I++, e++;
				...
				if (Array.isArray(Q)) {
					if (I) return (Q = FB(A, Q, g, B));
					FB(A, Q, null, B);
				} else
					null != Q && "" !== Q && A.firstChild
	...
	function kB(A, B, Q, g) {
		...
		for (let V = 0, I = B.length; V < I; V++) {
			let I,
				...
				t = Q?.[A.length];
			if (null == e || !0 === e || !1 === e);
			else if ("object" === (I = typeof e) && e.nodeType) A.push(e);
			else if (Array.isArray(e)) E = kB(A, e, t) || E;
			else if ("function" === I)
				if (g) {
					for (; "function" === typeof e; ) e = e();
					E =
						kB(A, Array.isArray(e) ? e : [e], Array.isArray(t) ? t : [t]) || E;
				} else A.push(e), (E = !0);
			else {
				const B = String(e);
				t && 3 === t.nodeType && t.data === B
					? A.push(t)
	...
	function pB(A, B, Q = null) {
		for (let g = 0, E = B.length; g < E; g++) A.insertBefore(B[g], Q);
	}
	function FB(A, B, Q, g) {
		if (void 0 === Q) return (A.textContent = "");
		const E = g || document.createTextNode("");
		if (B.length) {
			let g = !1;
			for (let V = B.length - 1; V >= 0; V--) {
				const I = B[V];
				if (E !== I) {
					const B = I.parentNode === A;
					g || V
						? B && I.remove()
						: B
							? A.replaceChild(E, I)
		...
		} else A.insertBefore(E, Q);
		return [E];
	}
	const GB = Symbol("store-raw"),
		NB = Symbol("store-node"),
		MB = Symbol("store-has"),
		RB = Symbol("store-self");
	function LB(A) {
		let B = A[aA];
		if (
			!B &&
			(Object.defineProperty(A, aA, { value: (B = new Proxy(A, bB)) }),
			!Array.isArray(A))
		) {
			const Q = Object.keys(A),
				g = Object.getOwnPropertyDescriptors(A);
			for (let E = 0, V = Q.length; E < V; E++) {
				const V = Q[E];
				g[V].get &&
					Object.defineProperty(A, V, {
						enumerable: g[V].enumerable,
						get: g[V].get.bind(B),
					});
			}
		}
	...
	function JB(A, B = new Set()) {
		let Q, g, E, V;
		if ((Q = A?.[GB])) return Q;
		if (!mB(A) || B.has(A)) return A;
		if (Array.isArray(A)) {
			Object.isFrozen(A) ? (A = A.slice(0)) : B.add(A);
			for (let Q = 0, V = A.length; Q < V; Q++)
				(E = A[Q]), (g = JB(E, B)) !== E && (A[Q] = g);
		} else {
			Object.isFrozen(A) ? (A = Object.assign({}, A)) : B.add(A);
			const Q = Object.keys(A),
				I = Object.getOwnPropertyDescriptors(A);
			for (let e = 0, t = Q.length; e < t; e++)
				(V = Q[e]),
					I[V].get || ((E = A[V]), (g = JB(E, B)) !== E && (A[V] = g));
		}
		return A;
	}
	function SB(A, B) {
		let Q = A[B];
		return (
			Q || Object.defineProperty(A, B, { value: (Q = Object.create(null)) }), Q
		);
	}
	function vB(A, B, Q) {
		if (A[B]) return A[B];
		const [g, E] = NA(Q, { equals: !1, internal: !0 });
		return (g.$ = E), (A[B] = g);
	}
	function UB(A) {
		vA() && vB(SB(A, NB), RB)();
	...
	const bB = {
		get(A, B, Q) {
			if (B === GB) return A;
			if (B === aA) return Q;
			if (B === lA) return UB(A), Q;
			const g = SB(A, NB),
				E = g[B];
			let V = E ? E() : A[B];
			if (B === NB || B === MB || "__proto__" === B) return V;
			if (!E) {
				const Q = Object.getOwnPropertyDescriptor(A, B);
				!vA() ||
					("function" === typeof V && !Object.hasOwn(A, B)) ||
					Q?.get ||
					(V = vB(g, B, V)());
			}
			return mB(V) ? LB(V) : V;
		...
		has: (A, B) =>
			...
			B === MB ||
			"__proto__" === B ||
			(vA() && vB(SB(A, MB), B)(), B in A),
		set: () => !0,
		deleteProperty: () => !0,
		ownKeys: (A) => (UB(A), Reflect.ownKeys(A)),
		getOwnPropertyDescriptor: (A, B) => {
			const Q = Reflect.getOwnPropertyDescriptor(A, B);
			return Q && !Q.get && Q.configurable && B !== aA && B !== NB
				? (delete Q.value, delete Q.writable, (Q.get = () => A[aA][B]), Q)
				: Q;
		},
	};
	function YB(A, B, Q, g = !1) {
		if (!g && A[B] === Q) return;
		const E = A[B],
			V = A.length;
		void 0 === Q
			? (delete A[B], A[MB]?.[B] && void 0 !== E && A[MB][B].$())
			: ((A[B] = Q), A[MB]?.[B] && void 0 === E && A[MB][B].$());
		let I,
			e = SB(A, NB);
		if (
			((I = vB(e, B, E)) && I.$(() => Q), Array.isArray(A) && A.length !== V)
		) {
			for (let B = A.length; B < V; B++) (I = e[B]) && I.$();
			(I = vB(e, "length", V)) && I.$(A.length);
		}
		(I = e[RB]) && I.$();
	}
	function KB(A, B) {
	...
	function xB(A, B, Q = []) {
		...
		if (B.length > 1) {
			...
			const V = typeof g,
				I = Array.isArray(A);
			if (Array.isArray(g)) {
				for (let E = 0; E < g.length; E++) xB(A, [g[E]].concat(B), Q);
				return;
			}
			if (I && "function" === V) {
				for (let E = 0; E < A.length; E++)
					g(A[E], E) && xB(A, [E].concat(B), Q);
				return;
			}
			if (I && "object" === V) {
				const { from: E = 0, to: V = A.length - 1, by: I = 1 } = g;
				for (let g = E; g <= V; g += I) xB(A, [g].concat(B), Q);
				return;
			}
			if (B.length > 1) return void xB(A[g], B, [g].concat(Q));
			(E = A[g]), (Q = [g].concat(Q));
		}
		let V = B[0];
		("function" === typeof V && ((V = V(E, Q)), V === E)) ||
			(void 0 === g && null == V) ||
			((V = JB(V)),
			void 0 === g || (mB(E) && mB(V) && !Array.isArray(V))
				? KB(E, V)
				: YB(A, g, V));
	}
	function TB(...[A, _B]) {
	...
	const HB = Symbol("store-root");
	function OB(A, B, Q, g, E) {
		const V = B[Q];
		if (A === V) return;
		const I = Array.isArray(A);
		if (
			Q !== HB &&
			(!mB(A) || !mB(V) || I !== Array.isArray(V) || (E && A[E] !== V[E]))
		)
			return void YB(B, Q, A);
		if (I) {
			if (A.length && V.length && (!g || (E && A[0] && null != A[0][E]))) {
				let B, Q, I, e, t, C, i, o;
				for (
					I = 0, e = Math.min(V.length, A.length);
					I < e &&
					(V[I] === A[I] || (E && V[I] && A[I] && V[I][E] === A[I][E]));
					I++
				)
					OB(A[I], V, I, g, E);
				const n = new Array(A.length),
					r = new Map();
				for (
					e = V.length - 1, t = A.length - 1;
					e >= I &&
					t >= I &&
					(V[e] === A[t] || (E && V[e] && A[t] && V[e][E] === A[t][E]));
					e--, t--
				)
					n[t] = V[e];
				if (I > t || I > e) {
					for (Q = I; Q <= t; Q++) YB(V, Q, A[Q]);
					for (; Q < A.length; Q++) YB(V, Q, n[Q]), OB(A[Q], V, Q, g, E);
					return void (V.length > A.length && YB(V, "length", A.length));
				}
				for (i = new Array(t + 1), Q = t; Q >= I; Q--)
					(C = A[Q]),
						(o = E && C ? C[E] : C),
						(B = r.get(o)),
						(i[Q] = void 0 === B ? -1 : B),
				...
				for (B = I; B <= e; B++)
					(C = V[B]),
						...
						void 0 !== Q &&
							-1 !== Q &&
							((n[Q] = V[B]), (Q = i[Q]), r.set(o, Q));
				for (Q = I; Q < A.length; Q++)
					Q in n ? (YB(V, Q, n[Q]), OB(A[Q], V, Q, g, E)) : YB(V, Q, A[Q]);
			} else for (let B = 0, Q = A.length; B < Q; B++) OB(A[B], V, B, g, E);
			return void (V.length > A.length && YB(V, "length", A.length));
		}
		const e = Object.keys(A);
		for (let B = 0, Q = e.length; B < Q; B++) OB(A[e[B]], V, e[B], g, E);
		const t = Object.keys(V);
		for (let B = 0, Q = t.length; B < Q; B++)
			void 0 === A[t[B]] && YB(V, t[B], void 0);
	}
	function WB(A, B = {}) {
		const { merge: Q, key: g = "id" } = B,
			E = JB(A);
		return (A) => {
			if (!mB(A) || !mB(E)) return E;
			const B = OB(E, { [HB]: A }, HB, Q, g);
			return void 0 === B ? A : B;
		};
	}
	const ZB = () => {},
	...
	const XB = (A) => A instanceof Element;
	function _B(A, B) {
		if (B(A)) return A;
		if ("function" === typeof A && !A.length) return _B(A(), B);
		if (Array.isArray(A))
			for (const Q of A) {
				const A = _B(Q, B);
				if (A) return A;
	...
	var AQ = { inout: "in-out", outin: "out-in" },
		BQ = (A) => {
			const B = ((A) =>
				RA(() => {
					const B = A.name || "s";
					return {
						enterActive: (A.enterActiveClass || `${B}-enter-active`).split(" "),
						enter: (A.enterClass || `${B}-enter`).split(" "),
						enterTo: (A.enterToClass || `${B}-enter-to`).split(" "),
						exitActive: (A.exitActiveClass || `${B}-exit-active`).split(" "),
						exit: (A.exitClass || `${B}-exit`).split(" "),
						exitTo: (A.exitToClass || `${B}-exit-to`).split(" "),
						move: (A.moveClass || `${B}-move`).split(" "),
					};
				}))(A);
			return zB(
				PB(() => A.children),
				{
					...
					onEnter(Q, g) {
						!((A, B, Q, g) => {
							const { onBeforeEnter: E, onEnter: V, onAfterEnter: I } = B;
							function e(B) {
								(B && B.target !== Q) ||
									(g?.(),
									Q.removeEventListener("transitionend", e),
									Q.removeEventListener("animationend", e),
									Q.classList.remove(...A.enterActive),
									Q.classList.remove(...A.enterTo),
									I?.(Q));
							}
							E?.(Q),
								Q.classList.add(...A.enter),
								Q.classList.add(...A.enterActive),
								queueMicrotask(() => {
									if (!Q.parentNode) return g?.();
									V?.(Q, () => e());
								}),
								$B(() => {
									Q.classList.remove(...A.enter),
										Q.classList.add(...A.enterTo),
										(!V || V.length < 2) &&
					...
					onExit(Q, g) {
						!((A, B, Q, g) => {
							const { onBeforeExit: E, onExit: V, onAfterExit: I } = B;
							if (!Q.parentNode) return g?.();
							function e(B) {
								(B && B.target !== Q) ||
									(g?.(),
									Q.removeEventListener("transitionend", e),
									Q.removeEventListener("animationend", e),
									Q.classList.remove(...A.exitActive),
									Q.classList.remove(...A.exitTo),
									I?.(Q));
							}
							E?.(Q),
								Q.classList.add(...A.exit),
								Q.classList.add(...A.exitActive),
								V?.(Q, () => e()),
								$B(() => {
									Q.classList.remove(...A.exit),
										Q.classList.add(...A.exitTo),
										(!V || V.length < 2) &&
											(Q.addEventListener("transitionend", e),
											Q.addEventListener("animationend", e));
								});
	...
	const QQ = cB("<span></span>", 2);
	var gQ = (A) => {
		const B = RA(() => {
				if (1 === A.t.length) {
					const B = A.t.codePointAt(0);
					if ((B >= 9600 && B <= 9631) || (B >= 57520 && B <= 57523)) return B;
				}
			}),
			Q = RA(() => (B() ? " " : A.t)),
			g = RA(() =>
				((A, B, Q, g) => {
					const E = { "--offset": B, width: `${Q + 0.01}ch` };
					const V = EQ(A.get("fg"), A.get("bold"));
					V && (E["--fg"] = V);
					if (g) {
						const B = EQ(A.get("bg"), !1);
						B && (E["--bg"] = B);
					}
					return E;
				})(A.p, A.x, A.w, A.cursor),
			),
			E = RA(() =>
				((A, B, Q, g) => {
					let E = g ? "ap-cursor" : "";
					void 0 !== B && (E += ` cp-${B.toString(16)}`);
					(A.has("bold") ||
						((V = A.get("fg")), "number" === typeof V && V >= 8 && V <= 15)) &&
						(E += " ap-bright");
					var V;
					A.has("faint") && (E += " ap-faint");
					A.has("italic") && (E += " ap-italic");
					A.has("underline") && (E += " ap-underline");
					A.has("blink") && (E += " ap-blink");
					A.get("inverse") && (E += " ap-inverse");
					1 === Q && (E += " ap-symbol");
					return "" === E ? void 0 : E;
				})(A.p, B(), A.w, A.cursor),
			);
		return (() => {
			const A = QQ.cloneNode(!0);
			return (
				fB(A, Q),
				MA(
					(B) => {
						const Q = E(),
							V = g();
						return (
							Q !== B._v$ && uB(A, (B._v$ = Q)), (B._v$2 = DB(A, V, B._v$2)), B
						);
					},
	...
	function EQ(A, B) {
		return "number" === typeof A
			? (B && A < 8 && (A += 8), `var(--term-color-${A})`)
			: "string" === typeof A
				? A
				: void 0;
	}
	const VQ = cB('<span class="ap-line" role="paragraph"></span>', 2);
	var IQ = (A) =>
		(() => {
			const B = VQ.cloneNode(!0);
			return (
				fB(
					B,
					gB(iB, {
						get each() {
							return (() => {
								if ("number" === typeof A.cursor) {
									...
									for (
										;
										g < A.segments.length && Q + A.segments[g].w - 1 < A.cursor;
									) {
										const E = A.segments[g];
										B.push(E), (Q += E.w), g++;
									}
									if (g < A.segments.length) {
										const E = A.segments[g],
											V = E.W;
										let I = A.cursor - Q;
										const e = Math.floor(I / V);
										I = e * V;
										const t = Array.from(E.t);
										for (
											e > 0 && B.push({ ...E, t: t.slice(0, e).join("") }),
												B.push({ ...E, t: t[e], x: Q + I, w: V, cursor: !0 }),
												e < t.length - 1 &&
													B.push({
														...E,
														t: t.slice(e + 1).join(""),
							...
							gB(
								...
								((...A) => {
									...
									for (let Q = 0; Q < A.length; Q++) {
										const g = A[Q];
										(B = B || (!!g && aA in g)),
											(A[Q] = "function" === typeof g ? ((B = !0), RA(g)) : g);
									}
									if (cA && B)
										return new Proxy(
											{
												...
												has(B) {
													for (let Q = A.length - 1; Q >= 0; Q--)
														if (B in IB(A[Q])) return !0;
													return !1;
												},
												keys() {
													const B = [];
													for (let Q = 0; Q < A.length; Q++)
														B.push(...Object.keys(IB(A[Q])));
													return [...new Set(B)];
												},
											},
											VB,
									...
									for (let B = A.length - 1; B >= 0; B--) {
										...
										for (let A = V.length - 1; A >= 0; A--) {
											const B = V[A];
											if ("__proto__" === B || "constructor" === B) continue;
											const I = Object.getOwnPropertyDescriptor(E, B);
											if (g[B]) {
												const A = Q[B];
												A &&
													(I.get
														? A.push(I.get.bind(E))
														: void 0 !== I.value && A.push(() => I.value));
											} else
												g[B] = I.get
													? {
															enumerable: !0,
															configurable: !0,
															get: eB.bind((Q[B] = [I.get.bind(E)])),
														}
													: void 0 !== I.value
														? I
														: void 0;
	...
	const eQ = cB(
			'<div class="ap-term"><svg class="ap-term-bg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" width="100%" height="100%" aria-hidden="true"><g shape-rendering="crispEdges"></g></svg><pre class="ap-term-text" aria-live="off" tabindex="0"></pre></div>',
			8,
		),
		tQ = cB('<svg><rect height="1.01"></rect></svg>', 4, !0);
	var CQ = (A) => {
		const B = () => A.lineHeight ?? 1.3333333333,
			Q = RA(() => ({
				width: `${A.cols}ch`,
				height: `${B() * A.rows}em`,
				"font-size": `${100 * (A.scale || 1)}%`,
				"--term-line-height": `${B()}em`,
				"--term-cols": A.cols,
			}));
		const g = RA(() => A.cursor?.[0]),
			E = RA(() => A.cursor?.[1]);
		return (() => {
			const B = eQ.cloneNode(!0),
				V = B.firstChild,
				I = V.firstChild,
				e = V.nextSibling;
			fB(
									...
									return (
										MA(
											(g) => {
												...
												var t;
												return (
													E !== g._v$5 && hB(Q, "x", (g._v$5 = E)),
													V !== g._v$6 && hB(Q, "y", (g._v$6 = V)),
													I !== g._v$7 && hB(Q, "width", (g._v$7 = I)),
													(g._v$8 = DB(Q, e, g._v$8)),
													g
												);
											},
											{
			...
			const t = A.ref;
			return (
				"function" === typeof t ? dB(t, e) : (A.ref = e),
				fB(
					e,
					gB(CB, {
						get each() {
				...
				MA(
					(g) => {
						const E = Q(),
							I = `0 0 ${A.cols} ${A.rows}`,
							t = !(!A.blink && !A.cursorHold),
							C = !!A.blink;
						return (
							(g._v$ = DB(B, E, g._v$)),
							I !== g._v$2 && hB(V, "viewBox", (g._v$2 = I)),
							t !== g._v$3 && e.classList.toggle("ap-cursor-on", (g._v$3 = t)),
							C !== g._v$4 && e.classList.toggle("ap-blink", (g._v$4 = C)),
							g
						);
					},
	...
	const yQ = cB(
		...
		kQ = cB('<span class="ap-tooltip">Unmute (m)</span>', 2),
		pQ = cB('<span class="ap-tooltip">Mute (m)</span>', 2),
		FQ = cB(
	...
	function MQ(A) {
		let B = Math.floor(A);
		const Q = Math.floor(B / 86400);
		B %= 86400;
		const g = Math.floor(B / 3600);
		B %= 3600;
	...
	var LQ = (A) => {
		const B = (A) => (B) => {
			...
			Q = () =>
				"number" === typeof A.currentTime ? MQ(A.currentTime) : "--:--",
			g = () =>
				"number" === typeof A.remainingTime ? `-${MQ(A.remainingTime)}` : Q(),
			E = RA(() =>
				"number" === typeof A.duration
					? A.markers.filter((B) => B[0] < A.duration)
					: [],
			),
			V = (A) => {
				const B = A.currentTarget.offsetWidth,
					Q = A.currentTarget.getBoundingClientRect(),
					g = A.clientX - Q.left;
				return `${100 * Math.max(0, g / B)}%`;
			},
			[I, e] = NA(!1),
			t = ((A, B) => {
				let Q = !0;
				return function () {
					if (Q) {
						Q = !1;
						for (var g = arguments.length, E = new Array(g), V = 0; V < g; V++)
							E[V] = arguments[V];
						A.apply(this, E), setTimeout(() => (Q = !0), B);
					}
				};
			})(A.onSeekClick, 50),
			C = (B) => {
				B._marker ||
					...
					B.ctrlKey ||
					0 !== B.button ||
					(e(!0), A.onSeekClick(V(B)));
			},
			i = (A) => {
				A.altKey || A.shiftKey || A.metaKey || A.ctrlKey || (I() && t(V(A)));
			},
			o = () => {
				e(!1);
			};
		return (
			...
			(() => {
				const V = GQ.cloneNode(!0),
					...
					c = A.ref;
				return (
					"function" === typeof c ? dB(c, V) : (A.ref = V),
					fB(
						V,
						gB(oB, {
							get when() {
							...
							get children() {
								const Q = yQ.cloneNode(!0);
								return (
									wB(Q, "click", B(A.onPlayClick)),
									fB(
										Q,
										gB(nB, {
											get children() {
					...
					fB(
						...
						gB(oB, {
							...
							get children() {
								const Q = qQ.cloneNode(!0),
									g = Q.firstChild.nextSibling;
								return (
									(Q.$$mousemove = i),
									(Q.$$mousedown = C),
									fB(
												...
												(() => {
													...
													return (
														...
														MA(
															(B) => {
																const g = ((B) =>
																		`${(B[0] / A.duration) * 100}%`)(Q),
																	I = !!((B) =>
																		"number" === typeof A.currentTime &&
																		B[0] <= A.currentTime)(Q);
																return (
																	g !== B._v$ &&
																		E.style.setProperty("left", (B._v$ = g)),
																	I !== B._v$2 &&
																		V.classList.toggle(
																			"ap-marker-past",
																			(B._v$2 = I),
									...
									MA((B) =>
										DB(g, { transform: `scaleX(${A.progress || 0}` }, B),
									),
									Q
								);
							},
					...
					fB(
						...
						gB(oB, {
							get when() {
								return void 0 !== A.isMuted;
							},
							get children() {
								const Q = FQ.cloneNode(!0);
								return (
									wB(Q, "click", B(A.onMuteClick)),
									fB(
										Q,
										gB(nB, {
											get children() {
					...
					wB(n, "click", B(A.onHelpClick)),
					fB(n, gB(rQ, {}), r),
					wB(s, "click", B(A.onFullscreenClick)),
					fB(s, gB(uQ, {}), a),
					fB(s, gB(oQ, {}), a),
					MA(() => V.classList.toggle("ap-seekable", !!A.isSeekable)),
					V
				);
			})()
		);
	};
	lB(["click", "mousedown", "mousemove"]);
	const mQ = cB(
		'<div class="ap-overlay ap-overlay-error"><span>💥</span></div>',
		4,
	);
	var JQ = (_A) => mQ.cloneNode(!0);
	const SQ = cB(
		'<div class="ap-overlay ap-overlay-loading"><span class="ap-loader"></span></div>',
		4,
	);
	var vQ = (_A) => SQ.cloneNode(!0);
	const UQ = cB(
		'<div class="ap-overlay ap-overlay-info"><span></span></div>',
		4,
	);
	var bQ = (A) =>
		(() => {
			const B = UQ.cloneNode(!0);
			return (
				fB(B.firstChild, () => A.message),
				MA(() => B.classList.toggle("ap-was-playing", !!A.wasPlaying)),
				B
			);
		})();
	const YQ = cB(
	...
	lB(["click"]);
	const xQ = cB("<li><kbd>space</kbd> - pause / resume</li>", 4),
		TQ = cB(
		...
		jQ = cB("<li><kbd>m</kbd> - mute / unmute audio</li>", 4),
		zQ = cB(
	...
	var XQ = (A) =>
		(() => {
			const B = zQ.cloneNode(!0),
				Q = B.firstChild,
				g = Q.firstChild.firstChild.nextSibling,
				E = g.firstChild,
				V = E.nextSibling;
			var I;
			return (
	...
	lB(["click"]);
	const _Q = cB('<div class="ap-wrapper" tabindex="-1"><div></div></div>', 4);
	var PQ = (A) => {
		const B = A.logger,
			Q = A.core,
			g = A.autoPlay,
			...
			G = RA(() => c().rows || 24),
			N = () => (!1 === A.controls ? 0 : 32);
		let M, R, L, m, J, S, v, U, b, Y;
		function K() {
			VA(), QA(), gA();
		}
		function x(A) {
			LA(() => {
				A.rows < c().rows && V("lines", E.lines.slice(0, A.rows)), l(A);
			});
		}
		function T(A) {
			null === A || g || V({ lines: A.lines, cursor: A.cursor });
		}
		const H = new Promise((A) => {
			Y = A;
		});
		Q.addEventListener("ready", (A) => {
			const { isPausable: B, isSeekable: Q, poster: g } = A;
			V({ isPausable: B, isSeekable: Q }), T(g), Y();
		}),
			Q.addEventListener("metadata", (A) => {
				const {
					cols: B,
					rows: Q,
					duration: g,
				...
				LA(() => {
					x({ cols: B, rows: Q }), u(g), p(E), D(I), T(V), C(!e && void 0);
				});
			}),
			Q.addEventListener("play", () => {
				r(null);
			}),
			Q.addEventListener("playing", () => {
				LA(() => {
					e(!0), o(!0), r(null), Z(), EA(), BA();
				});
			}),
			Q.addEventListener("idle", () => {
				LA(() => {
					e(!1), K();
				});
			}),
			Q.addEventListener("loading", () => {
				LA(() => {
					e(!1), K(), r("loader");
				});
			}),
			Q.addEventListener("offline", (A) => {
				const { message: B } = A;
				LA(() => {
					e(!1), K(), void 0 !== B && (a(B), r("info"));
				});
			}),
			Q.addEventListener("muted", (A) => {
				C(A);
			});
		let O = 0;
		Q.addEventListener("ended", (A) => {
			const { message: Q } = A;
			LA(() => {
				e(!1), K(), void 0 !== Q && (a(Q), r("info"));
			}),
				B.debug(`view: render count: ${O}`);
		}),
			Q.addEventListener("errored", () => {
				r("error");
			}),
			Q.addEventListener("resize", x),
			Q.addEventListener("reset", (A) => {
				const { cols: B, rows: Q, theme: g } = A;
				LA(() => {
					x({ cols: B, rows: Q }), p(g), Z();
				});
			}),
			Q.addEventListener("seeked", () => {
				gA();
			}),
			Q.addEventListener("terminalUpdate", () => {
				void 0 === M && (M = requestAnimationFrame(Z));
			});
		const W = () => {
			(b = new ResizeObserver(
				((A, B) => {
					...
					return function () {
						for (var g = arguments.length, E = new Array(g), V = 0; V < g; V++)
							E[V] = arguments[V];
						clearTimeout(Q), (Q = setTimeout(() => A.apply(this, E), B));
					};
				})((_A) => {
					V({ containerW: J.offsetWidth, containerH: J.offsetHeight }),
						J.dispatchEvent(new CustomEvent("resize", { detail: { el: S } }));
				}, 10),
			)),
				b.observe(J);
		};
		JA(async () => {
			B.info("view: mounted"),
				B.debug("view: font measurements", { charW: E.charW, charH: E.charH }),
				W(),
				V({ containerW: J.offsetWidth, containerH: J.offsetHeight });
		}),
			SA(() => {
				Q.stop(), VA(), QA(), b.disconnect();
			});
		const _Z = async () => {
				const A = await Q.getChanges();
				LA(() => {
					void 0 !== A.lines &&
						A.lines.forEach((A, B) => {
							V("lines", B, WB(A));
						}),
						void 0 !== A.cursor && V("cursor", WB(A.cursor)),
						V("cursorHold", !0);
				}),
					(M = void 0),
					(O += 1);
			...
			j = RA(() => {
				const B = E.charW * F() + E.bordersW,
					Q = E.charH * G() + E.bordersH;
				let g = A.fit ?? "width";
				if ("both" === g || E.isFullscreen) {
					g = E.containerW / (E.containerH - N()) > B / Q ? "height" : "width";
				}
				if (!1 === g || "none" === g) return {};
				if ("width" === g) {
					const A = E.containerW / B;
					return { scale: A, width: E.containerW, height: Q * A + N() };
				}
				if ("height" === g) {
					const A = (E.containerH - N()) / Q;
					return { scale: A, width: B * A, height: E.containerH };
				}
				throw `unsupported fit mode: ${g}`;
			}),
			z = () => {
				V(
					"isFullscreen",
			...
			P = (A) => {
				if (!(A.altKey || A.metaKey || A.ctrlKey)) {
					if (" " === A.key) Q.togglePlay();
					else if ("," === A.key) Q.step(-1).then(gA);
					else if ("." === A.key) Q.step().then(gA);
					else if ("f" === A.key) X();
					else if ("m" === A.key) iA();
					else if ("[" === A.key) Q.seek({ marker: "prev" });
					else if ("]" === A.key) Q.seek({ marker: "next" });
					else if (A.key.charCodeAt(0) >= 48 && A.key.charCodeAt(0) <= 57) {
						const B = (A.key.charCodeAt(0) - 48) / 10;
						Q.seek(`${100 * B}%`);
					} else if ("?" === A.key) _();
					else if ("ArrowLeft" === A.key)
						A.shiftKey ? Q.seek("<<<") : Q.seek("<<");
					else if ("ArrowRight" === A.key)
						A.shiftKey ? Q.seek(">>>") : Q.seek(">>");
					else {
						if ("Escape" !== A.key) return;
						q(!1);
					}
			...
			_BA = () => {
				L = setInterval(gA, 100);
			},
			_QA = () => {
				clearInterval(L);
			},
			_gA = async () => {
				const A = await Q.getCurrentTime(),
					B = await Q.getRemainingTime(),
					g = await Q.getProgress();
				V({ currentTime: A, remainingTime: B, progress: g });
			},
			_EA = () => {
				m = setInterval(() => {
					V((A) => {
						const B = { blink: !A.blink };
						return B.blink && (B.cursorHold = !1), B;
					});
				}, 600);
			},
			_VA = () => {
				clearInterval(m), V("blink", !0);
			},
			IA = (A) => {
				clearTimeout(R), A && (R = setTimeout(() => IA(!1), 2e3)), f(A);
			},
			eA = RA(() => {
				const B = A.theme || "auto/asciinema";
				return "auto/" === B.slice(0, 5)
					? { name: B.slice(5), colors: k() }
					: { name: B };
			}),
			tA = () => {
				H.then(() => Q.play());
			...
			nA = (() => {
				const B = _Q.cloneNode(!0),
					Q = B.firstChild;
				"function" === typeof J ? dB(J, B) : (J = B),
					B.addEventListener("webkitfullscreenchange", z),
					B.addEventListener("fullscreenchange", z),
					(B.$$mousemove = $),
					(B.$$keydown = P);
				return (
					"function" === typeof S ? dB(S, Q) : (S = Q),
					(Q.$$mousemove = () => IA(!0)),
					Q.addEventListener("mouseleave", AA),
					fB(
						Q,
						gB(CQ, {
							get cols() {
					...
					MA(
						(g) => {
							const E = !!(!0 === A.controls || ("auto" === A.controls && d())),
								V = `ap-player ap-default-term-ff asciinema-player-theme-${eA().name}`,
								I = (() => {
									const B = {};
									(!1 !== A.fit && "none" !== A.fit) ||
										...
										("small" === A.terminalFontSize
											...
											: "medium" === A.terminalFontSize
												...
												: "big" === A.terminalFontSize
													? (B["font-size"] = "24px")
													: (B["font-size"] = A.terminalFontSize));
									const Q = j();
									void 0 !== Q.width &&
										((B.width = `${Q.width}px`), (B.height = `${Q.height}px`)),
										void 0 !== A.terminalFontFamily &&
											(B["--term-font-family"] = A.terminalFontFamily);
									const g = eA().colors;
									return (
										g &&
											((B["--term-color-foreground"] = g.foreground),
											(B["--term-color-background"] = g.background),
											g.palette.forEach((A, Q) => {
												B[`--term-color-${Q}`] = A;
											})),
										B
									);
							...
							return (
								E !== g._v$ && B.classList.toggle("ap-hud", (g._v$ = E)),
								V !== g._v$2 && uB(Q, (g._v$2 = V)),
								(g._v$3 = DB(Q, I, g._v$3)),
								g
							);
						},
	...
	function $Q(A, B) {
		...
		const g = ((A, B) => {
				...
				(E.className = "ap-default-term-ff"),
					(E.style.height = "0px"),
					(E.style.overflow = "hidden"),
					(E.style.fontSize = "15px"),
					void 0 !== A && (E.style["--term-font-family"] = A);
				let V;
				document.body.appendChild(E);
				const I = aB(
						() => (
							(V = gB(CQ, { cols: Q, rows: g, lineHeight: B, lines: [] })), V
						),
						E,
					),
					e = {
						charW: V.clientWidth / Q,
						charH: V.clientHeight / g,
						bordersW: V.offsetWidth - V.clientWidth,
						bordersH: V.offsetHeight - V.clientHeight,
					};
				return I(), document.body.removeChild(E), e;
			})(Q.terminalFontFamily, Q.terminalLineHeight),
			E = {
				core: A,
				logger: Q.logger,
				cols: Q.cols,
		...
		let V;
		const I = aB(() => ((V = gB(PQ, E)), V), B);
		return { el: V, dispose: I };
	}
	lB(["keydown", "mousemove"]);
	const Ag = [
			"autoPlay",
			"autoplay",
			"cols",
		...
		(A.create = function (A, B) {
			...
			const E = g.logger ?? new Q(),
					...
					(function (A) {
						...
						const Q = Object.fromEntries(
							Object.entries(A).filter((A) => {
								const [B] = A;
								return Ag.includes(B);
							}),
						);
						return (Q.autoPlay ??= Q.autoplay), (Q.speed ??= 1), { ...Q, ...B };
					})(g, { logger: E }),
				),
				{ el: I, dispose: e } = $Q(
					V,
				...
				C = {
					el: I,
					dispose: e,
					getCurrentTime: () => t.then(V.getCurrentTime.bind(V)),
					getDuration: () => t.then(V.getDuration.bind(V)),
					play: () => t.then(V.play.bind(V)),
					pause: () => t.then(V.pause.bind(V)),
					seek: (A) => t.then(() => V.seek(A)),
					addEventListener: (A, B) => V.addEventListener(A, B.bind(C)),
				};
			return C;
		}),
		A
