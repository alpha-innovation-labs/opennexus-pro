...
export function NexusTypingScene(props: NexusTypingSceneProps): JSX.Element {
  ...
  const chars = Math.floor(interpolate(local, [28, 116], [0, PROMPT.length], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }));

  return (
    <NexusTerminal>
      <div style={{ height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 70px", boxSizing: "border-box", gap: 86 }}>
        <StartupLogo startFrame={props.startFrame + 4} fontSize={26} />
