...
import { bootstrapAssistantActivityGrouping } from "../../../packages/extension-core/src/tron/activity/bootstrapAssistantActivityGrouping.js";
...
test("tron ignores resumed collapse timing reconstruction while grouping stays disabled", async () => {
	...
	bootstrapAssistantActivityGrouping([
		{ type: "message", message: firstMessage } as never,
		{ type: "message", message: secondMessage } as never,
	]);
