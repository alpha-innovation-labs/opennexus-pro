...
export type TaskAction = "create" | "create_many" | "update" | "list" | "get" | "delete" | "delete_many" | "clear";
...
export interface Task extends BulkCreateTaskInput {
	id: number;
	status: TaskStatus;
}
...
// pre-refactor schema at `packages/extensions-dev/src/todo/todo.ts:512-573`.
// ---------------------------------------------------------------------------

const BulkCreateTaskInputSchema = Type.Object({
	...
	blockedBy: Type.Optional(
		Type.Array(Type.Number(), {
			description: "Initial blockedBy ids",
		}),
	),
...
export const TodoParamsSchema = Type.Object({
	action: StringEnum(["create", "create_many", "update", "list", "get", "delete", "delete_many", "clear"] as const),
	...
	items: Type.Optional(
		Type.Array(BulkCreateTaskInputSchema, {
			description: "Task items for create_many",
		}),
	),
	id: Type.Optional(
		Type.Number({
	...
	ids: Type.Optional(
		Type.Array(Type.Number(), {
			description: "Task ids for delete_many",
		}),
	),
