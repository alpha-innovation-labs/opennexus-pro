...
Location: `~/.config/nexus/config.json` (Nexus's unified config file)

> **[NOTE]** The web-tools config is stored under `searxng`/`crawl4ai`/`jina` sub-sections within `config.json`.
