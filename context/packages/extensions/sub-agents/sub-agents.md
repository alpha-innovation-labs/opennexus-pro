...
- [[features/tooling/steer-subagent-tool|steer-subagent-tool]]: Queues or forwards steering messages, re-prompts completed runs, and records them in the child transcript as user entries.
