...
/**
 * Verifies the compiled release can open /tools without resolving Pi from /$bunfs.
 */
test("released nexus opens /tools without module resolution failures", async () => {
