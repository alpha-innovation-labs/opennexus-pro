...
- Source path: `src/wterm-demo/config`
- Parent: [`wterm-demo`](../wterm-demo.md)

## What this area covers

`src/wterm-demo/config` is the `config` side of the web-terminal demo. It is a leaf folder with 1 file and no nested directories.

## Key files

- `src/wterm-demo/config/getWtermDemoPort.ts`
...
1. `src/wterm-demo/config/getWtermDemoPort.ts`
