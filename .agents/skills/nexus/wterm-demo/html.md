...
- Source path: `src/wterm-demo/html`
- Parent: [`wterm-demo`](../wterm-demo.md)

## What this area covers

`src/wterm-demo/html` is the `html` side of the web-terminal demo. It is a leaf folder with 1 file and no nested directories.

## Key files

- `src/wterm-demo/html/createWtermHtmlDocument.ts`
...
1. `src/wterm-demo/html/createWtermHtmlDocument.ts`
